---
Title: Как добавить горизонтальную полосу прокрутки (scrollbar) в TListBox?
Date: 01.01.2007
...
Конечно же существует способ добавить горизонтальную
полосу прокрутки! Добавьте следующий код в событие Вашей формы OnCreate.
