---
Title: Условие создания главной формы
Date: 01.01.2007
...
необходимый для создания форм код, но не допускаем его выполнения
(`IF FALSE THEN`), при этом компилятор не ругается, а мы тем временем (во
...
Пара "подходящих" для CreateForm форм заключена в никогда не
