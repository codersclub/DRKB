...
<table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>1. Вывод примитивов без заливки (для этого в GDI+ предусмотрены функции начинающиеся с Draw...)</td></tr></table></div><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>2. Вывод примитивов с заливкой (для этого в GDI+ предусмотрены функции начинающиеся с Fill...)</td></tr></table></div><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>3. Создание мини-просмотра</td></tr></table></div><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>4.Вывод оригинального изображения, вывод растянутого и вывод изображения в параллелограмм.</td></tr></table></div><p>Рассмотрим это в коде :</p>
<pre>
