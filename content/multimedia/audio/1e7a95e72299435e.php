<h1>Низкоуровневые процедуры обработки звука</h1>
<div class="date">01.01.2007</div>


<p>Ниже приведен код, обрабатывающий аудиосигнал, получаемый со входа звуковой карты (SoundBlaster). Надеюсь он поможет разобраться вам с этой сложной темой.</p>

<p>Включенный в код модуль RECUNIT делает всю изнурительную работу по извлечению звука со входа звуковой карты.</p>
<pre>
var
