<h1>Основы программирования OpenGL в Borland Delphi (Статья)</h1>
...
<p class="note">Примечание: [f d] &#8211; означает, что в конце может быть либо буква &#8220;f&#8221;, либо &#8220;d&#8221;.</p>
...
<p class="note">Примечание: вместо звёздочки &#8216;*&#8217; ставятся соответствующие суффиксы; такое сокращение принято во многих документациях по OpenGL.</p>
<p>Точки</p>
...
<p class="note">Примечание: в FormResize я вызвал glOrtho следующим образом - glOrtho(-1,12, -1,12, 2,12). Это &#8211; для того, чтобы все точки поместились в окне.</p>
