...
ничего путного не увидел. Здесь я использую простой алгоритм.
...
P.S Назвал я класс PLU потому, что так проще расшифровывается,
как плеер удаленный.

P.S.S Я устал уже отвечать на такие письма типа:
"У меня не распаковывается архив?".
