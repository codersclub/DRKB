...
спрайтов, а если их больше он или выходит или подвисает. Так что, делаем
вот так:

В класс с плеером добавляем две переменные, он теперь выглядит так (я
добавил комментарии к тем строчкам которые изменились):
...
![clip0108](/pic/clip0108.png){width="120" height="38"}
...
![clip0109](/pic/clip0109.png){width="300" height="175"}
...
![clip0110](/pic/clip0110.png){width="192" height="32"}
...
![clip0111](/pic/clip0111.png){width="175" height="112"}
