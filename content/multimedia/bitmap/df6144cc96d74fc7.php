<h1>Как из Handle битовой картинки получить адрес битового изображения в памяти?</h1>
<div class="date">01.01.2007</div>

Автор: Nomadic </p>
<p>Вот кусок одного моего класса, в котором есть две интересные вещицы - проецирование файлов в память и работа с битмэпом в памяти через указатель. </p>
<p>Сразу оговорюсь, что все это работает только под Win95/NT.</p>
<pre>
type
