<h1>Об основах ассемблерных процедур</h1>
...
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 19px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="17">First</td><td>=        EBP + $10        (EBP + 16)</td></tr></table></div>
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 19px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="17">Second</td><td>=        EBP + $0C        (EBP + 12)</td></tr></table></div>
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 19px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="17">Third</td><td>=        EBP + $08        (EBP + 8)</td></tr></table></div>
<p>В действительности, вы будете просто ссылаться на них по их именам, компилятор сам рассчитает необходимые смещения самостоятельно. Так, для выше описанного случая, напишите:</p>
mov EAX,First</p>
...
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 19px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="17">EBP+0x10</td><td>m</td></tr></table></div>
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 19px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="17">EBP+0x08</td><td>v</td></tr></table></div>
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 19px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="17">EBP+0x04</td><td>адрес возврата</td></tr></table></div>
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 19px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="17">EBP -&gt;</td><td>предыдущий EBP</td></tr></table></div>
<p>Вы никогда не должны забывать, что внутри сопроцессора они обрабатываются как 10-байтные числа с плавающей запятой. Результат остается в ST(0) (верхушка стека математического сопроцессора). Это извлекается кодом, который вызвал функцию.</p>
