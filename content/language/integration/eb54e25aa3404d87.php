<h1>Вызов сишной функции с переменным числом параметров</h1>
<div class="date">01.01.2007</div>


<p class="author">Автор: Владимир Переплетчик </p>
...
<p>В таком виде методика уже имеет смысл. Изменения при типах вызова cdecl / pascal понятны. </p><p>Взято с <a href="https://delphiworld.narod.ru" target="_blank">https://delphiworld.narod.ru</a></p>
