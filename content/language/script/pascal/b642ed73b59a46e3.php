...
<div style="text-align: justify; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 8px 24px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>Разрешены только числовые показатели</td></tr></table></div>
...
<pre>{ Parse and Translate a Math Factor } 
...
<pre>{ Skip Over Leading White Space } 
procedure SkipWhite; 
begin 
...
<pre>{ Match a Specific Input Character } 
