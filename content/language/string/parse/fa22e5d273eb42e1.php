...
<a href="https://msdn.microsoft.com/downloads/default.asp?URL=/downloads/sample.asp?url=/msdn-files/027/001/733/msdncompositedoc.xml" target="_blank">https://msdn.microsoft.com/downloads/default.asp?URL=/downloads/sample.asp?url=/msdn-files/027/001/733/msdncompositedoc.xml</a></p>

<p>Download the desired package. Once downloaded, run it to install.</p>
...
<p>Note that the auto-installing package, you have downloaded from the internet, automatically do it.</p>

<p>Now let's go to import the type library in Delphi:</p>
