<h1>Удаление из файла элементов HTML</h1>
...
<p>Где:</p>
<p>filename</p>
<p>это имя файла, который вы хотите обработать.</p>
<p>WebPage</p>
<p>это TStringList</p>
<p>последний параметр в функции</p>
<p>указывает, применять или нет HTML-фильтр.</p>
