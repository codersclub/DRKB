...
<p>Table1.fieldByName('aaaaa').asString:='чего-то там';</p>
<p>Table1.fieldByName('sdweewr').asString:='чего-то там 1';</p>
<p>Table1.fieldByName('sdfsdfga').asString:='чего-то там2';</p>
<p>Table1.fieldByName('a').asString:='чего-то там 4';</p>
<p>Table1.fieldByName('pyoruw').asString:='чего-то там 5';</p>
...
<p>Table1.params.parambyname('aaaaa').value:='чего-то там'+v;</p>
