...
полжизни проводящих: а) в поисках библиотеки, которая делает именно то,
что нужно; б) в чатах по поводу \"а почему не работает найденная
...
создать документ\
установить глобальные переменные, типа шрифтов,стандартных реквизитов и
т.п.\
цикл {\
