<h1>Пример работы чтения и сохранении wav-файлов</h1>
...
<p>Скачать необходимые для компиляции файлы проекта можно на <a href="https://program.dax.ru" target="_blank">program.dax.ru</a>.</p>
<pre>
type
  TWaveHeader = record
