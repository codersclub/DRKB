...
установленных в системе криптопровайдерах, приведен в
...
ключа, который можно использовать для шифрования
...
См. процедуру, реализующую процесс подписания; результатом ее работы
является файл,
...
предполагает использование сертификатов.
