...
<table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>QuickReport Pro 4.06 фирмы QBS Software Ltd</td></tr></table></div><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>Rave Reports 7.0 фирмы Nevrona Designs</td></tr></table></div><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>FastReport 3.23 фирмы Fast Reports Inc</td></tr></table></div><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>FastReport 2.56 VCL фирмы Fast Reports Inc</td></tr></table></div><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>ReportBuilder 10.02 фирмы Digital Metaphors Corporation</td></tr></table></div><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>Crystal Reports 11.0 фирмы Business Objects SA</td></tr></table></div><p>Все участники опытные, хорошо известны Delphi-разработчикам, обычно, именно между ними и стоит выбор. Надо сказать, что, если визуально различий между ними не так уж и много (к примеру, вы без проблем перейдёте от дизайнера отчётов Crystal Reports к ReportBuilder, как, впрочем, и почти к любому из участников) архитектурно же они различаются очень сильно.</p>
<p>QuickReport<br>
...
<table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>Создание и сохранение в файл простого отчета из 2-х страниц с использованием 6-ти полей БД.</td></tr></table></div><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>Создание и сохранение в файл сложного отчета из 14-ти страниц с использованием всех полей БД.</td></tr></table></div><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>Экспорт в формат Acrobat PDF сложного отчета из 14-ти страниц с использованием всех полей БД.</td></tr></table></div><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>Экспорт в формат HTML сложного отчета из 14-ти страниц с использованием всех полей БД.</td></tr></table></div><p>На старт!</p>
