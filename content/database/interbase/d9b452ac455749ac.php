...
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 24px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">1.</td><td>Создание и инициализация  дескриптора БД для каждой подключаемой БД</td></tr></table></div>
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 24px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">2.</td><td>Создание и заполнение DPB(буфер параметров БД) для каждой подключаемой БД</td></tr></table></div>
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 24px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">3.</td><td>Вызов isc_expand_dpb() до подключения к БД для предварительного создания и заполнения DPB (если лень заполнять его руками).</td></tr></table></div>
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 24px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">4.</td><td> Вызов isc_attach_database() для каждой БД к которой будете подключаться</td></tr></table></div>
...
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 24px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">1.</td><td>Первый байт кластера определяет параметр который будет описываться далее в кластере. Этот байт равен одной из констант - идентификаторов параметров объявленных в ibase.h  (например, константа isc_dpb_num_buffers говорит, что после нее последует определение числа буферов кэша БД).</td></tr></table></div>
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 24px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">2.</td><td>Второй байт кластера содержит число, определяющее размер параметра в байтах.</td></tr></table></div>
...
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 24px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>Указатель на вектор ошибки, откуда можно узнать ошибках если они были.</td></tr></table></div>
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 24px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>Длина в байтах имени БД для открытия БД. Если имя БД включает имя и путь, указывается их общая длина.</td></tr></table></div>
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 24px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>Строка содержащая имя БД для подключения. Имя может включать имя БД и путь к ней.</td></tr></table></div>
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 24px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>Указатель на дескриптор БД .</td></tr></table></div>
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 24px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>Длина в байтах DPB. Если DPB остался по умолчанию то, устанавливается в 0.</td></tr></table></div>
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 24px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>Указателъ на DPB. Если DPB остался по умолчанию то, устанавливается в NULL.</td></tr></table></div>
...
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 24px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">1.</td><td>Первый байт определяет информация о каком параметре содержится в этом кластере, он равен одной из констант определенных в ibase.h и уже описанных выше.</td></tr></table></div>
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 24px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">2.</td><td>Далее идут два байта - содержащие число равное числу байт оставшихся до конца кластера, фактически размер значения параметра в байтах.</td></tr></table></div>
...
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 28px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>1 байт определяет что за параметр возвратился (например, isc_info_insert_count).</td></tr></table></div>
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 28px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>2 байта , сообщающие, сколько байт составляют следующая пара значений.</td></tr></table></div>
...
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 52px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>2 байта определяют ID таблицы</td></tr></table></div>
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 52px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>4 байта показывают число операций (к примеру, вставки) произведенных над таблицей</td></tr></table></div>
<p>Совет: чтобы определить настоящее имя таблицы из ID таблицы  выполните запрос к системной таблице, RDB$RELATION.</p>
...
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 24px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">1.</td><td>Создание и инициализация дескриптора транзакции для каждой одновременно стартующей транзакции.</td></tr></table></div>
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 24px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">2.</td><td>Необязательное создание и заполнение TPB для каждой транзакции.</td></tr></table></div>
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 24px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">3.</td><td>Вызов ф-ии isc_start_transaction() для старта каждой транзакции</td></tr></table></div>
...
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 81px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>Номер версии буфера параметров транзакции (Transaction version number), используется ядром InterBase.</td></tr></table></div>
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 81px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>Режим доступа (Access mode) описывает действия, которые могут быть выполнены функциями связанными с транзакцией. Существуют следующие режимы доступа:</td></tr></table></div>
<p>                                    isc_tpb_read</p>
<p>                                    isc_tpb_write</p>
...
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 76px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>Разрешение конфликтов блокировок (Lock resolution). Описывает как транзакция должна вести себя если происходит конфликт блокировок. Существуют два вида реакции.                                                                isc_tpb_wait                                                                isc_tpb_nowait</td></tr></table></div>
...
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 24px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>isc_tpb_no_rec_version, заданное по умолчанию, определяет что транзакция может видеть только самую последнюю версию записи. Если изменение записи продолжается, но не завершено подтверждением, запись не может быть прочитана.</td></tr></table></div>
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 24px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>isc_tpb_rec_version определяет что транзакция может читать самую последнюю подтвержденную версию записи, даже если самая последняя не подтвержденная версия записи не завершилась и продолжает изменение.</td></tr></table></div>
<p>Следующее объявление создает TPB с уровнем изоляции read_committed, и определяет транзакцию которая может читать самую последнюю версию записи.</p>
<p>static char isc_tpb[] = {isc_tpb_version3,</p>
<p>                                      isc_tpb_write,</p>
<p>                                      isc_tpb_read_committed,</p>
...
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 24px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>isc_tpb_wait, по умолчанию определяет что транзакция будет ожидать пока блокированные ресурсы не освободятся. Как только ресурсы освободятся транзакция повторит операцию.</td></tr></table></div>
...
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 24px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>Предотвращение возможных тупиковых ситуаций и конфликтов обновления, которые могут происходить, если блокировки принимаются только там  где они фактически необходимы (поведение по умолчанию).</td></tr></table></div>
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 24px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>Предусмотрение  зависимой блокировки, блокировок таблиц, на которые можно воздействовать ограничениями целостности и триггерами. Если есть явная зависимость, блокировка не требуется, можно ручаться, что конфликты обновлений не произойдут из-за косвенных конфликтов таблиц.(!!!!!!!!!!!!!!!!!!!!!!!!!!!!)</td></tr></table></div>
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 24px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>Изменение уровеня разделяемого доступа для одной или нескольких таблиц в транзакции. Например, isc_tpb_write транзакция с уровнем изоляции isc_tpb_concurrency может нуждаться в исключительных правах на изменения для отдельной таблицы, и могла бы использовать параметр резервирования, чтобы гарантировать себе единственный доступ для записи в таблицу.</td></tr></table></div>
<p>Виды резервирования:</p>
...
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 24px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>Встраивание DSQL API  ф-ий в приложение.</td></tr></table></div>
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 24px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>Использование средств базового языка, таких как типы данных и макрокоманды, чтобы предоставить области ввода и вывода для проходящих инструкций и параметров во время выполнения.</td></tr></table></div>
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 24px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>Программные методы, которые используют эти инструкции и средства, чтобы обработать инструкции SQL во время выполнения.</td></tr></table></div>
<p>Эти шаги описываются детально в этой главе.</p>
<p>Ограничения для DSQL API</p>
<p>Хотя DSQL предлагает много преимуществ, но он также имеет следующие ограничения.</p>
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 24px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>Динамическая обработка транзакций не разрешается; все именованные транзакции должны быть объявлены во время компиляции.</td></tr></table></div>
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 24px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>Динамический доступ к Blob и массивам данных не поддерживается; К Blob  и массивам данных можно обращаться, но только через стандартные, статически обработанные инструкции SQL, или через вызовы API нижнего уровня.</td></tr></table></div>
...
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 24px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">1.</td><td>Предыдущие транзакции закончились подтверждением  или откачены назад.</td></tr></table></div>
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 24px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">2.</td><td>Дескриптор транзакции установлен в NULL.</td></tr></table></div>
<p>Создание базы данных</p>
<p>Создание новой базы данных в API приложении:</p>
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 24px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">1.</td><td>Отсоединитесь от всех БД с помощью isc_detach_database().</td></tr></table></div>
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 24px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">2.</td><td>Сформируйте инструкцию  CREATE DATABASE для обработки.</td></tr></table></div>
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 24px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">3.</td><td>Выполните инструкцию с помощью isc_dsql_execute_immediate () или isc_dsql_exec_immed2 ().</td></tr></table></div>
<p>К примеру, следующие инструкции отсоединяют все подключенные БД и создают новую БД. Любой дескриптор существующей БД устанавливается в NULL, и может быть использован в будущем для подключения к новым БД.</p>
...
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 24px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>Текст SQL инструкции</td></tr></table></div>
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 24px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>Число базовых переменных</td></tr></table></div>
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 24px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>Типы базовых переменных</td></tr></table></div>
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 24px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>Ссылки на объекты БД</td></tr></table></div>
<p>Создание приложения API DSQL гораздо сложнее, чем программирование  приложений со встроенным SQL и со статическим SQL, потому что для большинства операций DSQL, приложение должно явно выделить и обработать расширенный дескриптор области  SQL (XSQLDA) - структура данных, чтобы передать данные в БД  или из БД.</p>
<p>Использование API для обработки DSQL инструкций предполагает следующие основные шаги:</p>
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 24px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">1.</td><td>Определите, могут ли вызовы API обработать инструкцию SQL.</td></tr></table></div>
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 24px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">2.</td><td>Представьте инструкцию SQL как строку символов в приложении.</td></tr></table></div>
...
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 24px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">4.</td><td>Используйте соответствующие API, и программные методы, чтобы обработать инструкцию SQL.</td></tr></table></div></p>
...
<table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="236"></td><td>устанавливается IB с помощью isc_dsql_prepare () или isc_dsql_describe ()</td></tr></table></div>
...
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 24px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>Тип данных параметра или select-списка.</td></tr></table></div>
...
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 24px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>Используйте isc_dsql_execute_immediate (), чтобы подготовить и выполнить строку сразу.</td></tr></table></div>
...
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 24px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">1.</td><td>Создание структуры ввода XSQLDA для обработки строки инструкции.</td></tr></table></div>
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 24px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">2.</td><td>Подготовка и выполнения строки инструкции с параметрами.</td></tr></table></div>
...
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 24px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">6.</td><td>Обработайте каждый XSQLVAR параметр в структуре XSQLDA. Это выглядит так:</td></tr></table></div>
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 48px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">a.</td><td>Приведите типы данных  параметров (необязательно).</td></tr></table></div>
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 48px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">b.</td><td>Выделите   память  для локальных данных, указанных полем sqldata XSQLVAR. Этот шаг только требуется, если память для локальных переменных выделено до времени выполнения. Следующий пример иллюстрирует динамическое выделение  памяти для локальных переменных:</td></tr></table></div>
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 48px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">c.</td><td>Значение параметра должно быть совместимого типа данных(обязательно)</td></tr></table></div>
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 48px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">d.</td><td>Определите  индикатор  NULL значения для параметра.</td></tr></table></div></p>
...
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 24px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">1.</td><td>Подготовьте XSQLDA вывода для обработки элементов списка выбора возвращенных при выполнении запроса.</td></tr></table></div>
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 24px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">2.</td><td>Подготовьте строку инструкции.</td></tr></table></div>
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 24px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">3.</td><td>Используйте курсор для выполнения инструкции и извлечения элементов списка выбора из XSQLDA вывода.</td></tr></table></div>
...
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 48px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">e.</td><td>Приведите типы данных  параметров (необязательно).</td></tr></table></div>
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 48px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">f.</td><td>Выделите   память  для локальных данных, указанных полем sqldata XSQLVAR. Этот шаг только требуется, если память для локальных переменных выделена до времени выполнения. Следующий пример иллюстрирует динамическое выделение  памяти для локальных переменных:</td></tr></table></div>
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 48px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">g.</td><td>Значение параметра должно быть совместимого типа данных(обязательно)</td></tr></table></div>
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 48px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">h.</td><td>Определите  индикатор  NULL - значения для параметра.</td></tr></table></div>
<p>Следующий пример кода иллюстрирует эти шаги, и выполняет цикл для каждой структуры XSQLVAR принадлежащей out_sqlda XSQLDA:</p>
<pre>
...
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 48px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">b.</td><td>Выделите   память  для локальных данных, указанных полем sqldata XSQLVAR. Этот шаг только требуется, если память для локальных переменных выделена до времени выполнения. Следующий пример иллюстрирует динамическое выделение  памяти для локальных переменных:</td></tr></table></div>
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 48px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">c.</td><td>Значение параметра должно быть совместимого типа данных(обязательно)</td></tr></table></div>
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 48px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">d.</td><td>Определите    NULL значение индикатора для параметра</td></tr></table></div>
<p>Эти шаги должны быть представлены в следующем порядке. Следующий пример кода иллюстрирует эти шаги, и выполняет цикл для каждой структуры XSQLVAR в in_sqlda XSQLDA:</p>
<pre>
for (i=0, var = in_sqlda-&gt;sqlvar; i &lt; in_sqlda-&gt;sqld; i++, var++)
{
...
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 48px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">g.</td><td>Значение параметра должно быть совместимого типа данных(обязательно)</td></tr></table></div>
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 48px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">h.</td><td>Определите  индикатор  NULL значения для параметра.</td></tr></table></div>
<p>Следующий пример кода иллюстрирует эти шаги, выполняет цикл для каждой структуры XSQLVAR принадлежащей out_sqlda XSQLDA:</p>
...
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 24px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">-</td><td>Тип инструкции</td></tr></table></div>
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 24px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">-</td><td>Число параметров ввода требуемое для инструкции</td></tr></table></div>
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 24px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">-</td><td>Число параметров вывода возвращаемое инструкцией</td></tr></table></div>
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 24px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">-</td><td> Детальную информацию относительно каждого входного параметра или выходного значения , включая его тип данных, масштаб, и длину.</td></tr></table></div>
<p>Чтобы использовать isc_dsql_sql_info (), выделите буфер списка элементов, который описывает тип требуемой информации, и выделите буфер результатов, куда функция может возвращать нужную информацию. Например, чтобы определить  неизвестный тип инструкции, но подготовленной инструкции, вы должны выделить буфер списка элементов с одним элементом, и заполнять его макро константой  isc_info_sql_stmt_type, определенной в ibase.h:</p>
<p>char type_item[];</p>
...
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 24px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>isc_decode_sql_date() конвертирует внутренний формат даты IB  к формату С структуры date</td></tr></table></div>
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 24px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>isc_encode_sql_date() делает тоже, но обратно</td></tr></table></div>
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 24px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>isc_decode_sql_time() конвертирует внутренний формат времени IB к формату С структуры time</td></tr></table></div>
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 24px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>isc_encode_sql_time() делает тоже, но обратно</td></tr></table></div>
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 24px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>isc_decode_timestamp() конвертирует внутренний формат timestamp IB к формату С структуры timestamp ; Это прежде выполнялось вызовом isc_decode_date ();</td></tr></table></div>
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 24px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>isc_encode_timestamp() делает тоже, но обратно; Это прежде выполнялось вызовом isc_encode_date ();</td></tr></table></div>
...
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 24px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">1.</td><td>Чтение из BLOB.</td></tr></table></div>
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 24px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">2.</td><td> Вставка новой строки включающей BLOB данные</td></tr></table></div>
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 24px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">3.</td><td>Замена данных ссылающихся на  BLOB столбец.</td></tr></table></div>
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 24px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">4.</td><td>Обновление данных ссылающихся на  BLOB столбец.</td></tr></table></div>
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 24px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">5.</td><td>Удаление BLOB.</td></tr></table></div>
...
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 24px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">-</td><td>Приводим элементы типо данных (необязательно), к примеру, из SQL_VARYING к SQL_TEXT.</td></tr></table></div>
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 24px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">-</td><td>Динамически выделяем место для хранения данных на которые указывает sqldata</td></tr></table></div>
<p>Для обоих:</p>
...
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 24px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">1.</td><td>Объявите и инициализируйте BLOB дескриптор</td></tr></table></div>
<p>      isc_blob_handle blob_handle; /* Обьявление BLOB дескритора. */</p>
blob_handle = NULL; /* Устанвите его в NULL перед использованием*/</p>
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 24px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">2.</td><td>Создайте буфер для хранения каждого прочитанного BLOB сегмента. Его размер должен быть максимальным размером сегмента в вашей программе используемой для чтения BLOB.</td></tr></table></div>
<p>            char blob_segment[80];</p>
...
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 24px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">-</td><td>Включить BLOB данные в строку втавляемую в таблицу</td></tr></table></div>
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 24px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">-</td><td>Заменить данные ссылающиеся на BLOB столбец строки</td></tr></table></div>
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 24px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">-</td><td>Обновить данные ссылающиеся на BLOB столбец строки</td></tr></table></div>
...
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 24px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">-</td><td>Создать новый BLOB</td></tr></table></div>
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 24px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">-</td><td>Прочитать данные из старого BLOBA в буфер где вы сможете отредактировать и модифицировать их.</td></tr></table></div>
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 24px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">-</td><td>Записать измененные данные в новый BLOB.</td></tr></table></div>
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 24px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">-</td><td>Подготовить и выполнить инструкцию UPDATE которая модифицирует BLOB столбец содержащий BLOB ID нового BLOB, заменяющий старый BLOB ID.</td></tr></table></div>
<p>Секция ниже описывает шаги требуемые для вставки, обновления, и замены BLOB данных.</p>
...
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 24px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">-</td><td>Определяем типы данных элементов</td></tr></table></div>
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 24px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">-</td><td>Для параметров типы которых известны во время компиляции: указатель sqldata  связываем с локальной перемнной содержаещей передаваемый данные.</td></tr></table></div>
...
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 24px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">-</td><td>Определяем число байт данных (размер)</td></tr></table></div>
...
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 24px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">-</td><td>Удаляем строку содержащую BLOB. Вы можете использовать DSQL для выполнения DELETE инструкции.</td></tr></table></div>
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 24px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">-</td><td>Заменяем различные BLOB. Если Blob столбец содержит Blob ID, и вы модифицируете столбец ссылающийся на разные BLOB, ранее сохраненный BLOB будет удален слудующей сборкой “мусора”.</td></tr></table></div>
...
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 24px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">1.</td><td>Первый байт определяет тип возвращенной информации.</td></tr></table></div>
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 24px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">2.</td><td>Второй байт - число определяющее число байт до конца кластера (длина инфо)</td></tr></table></div>
...
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 24px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">-</td><td>Вызываем isc_blob_default_desc().  И заполняем ей поля дескриптора значениями по умолчанию. Подтип по умолчанию есть 1 (TEXT), сегмент размером 80 байт, кодовая страница по умолчанию есть страница установленная для вашего процесса.</td></tr></table></div>
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 24px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">-</td><td>Вызываем isc_blob_lookup_desc(). Она обращается к системным таблицам и берет оттуда информацию о BLOB и заполняет ею поля дескриптора.</td></tr></table></div>
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 24px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">-</td><td>Вызываем isc_blob_set_desc(). Она инициализирует дескриптор из парметров вызова, быстрее нежели получать доступ к метаданным.</td></tr></table></div>
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 24px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">-</td><td>Устанавливаем поля дескриптора напрямую.</td></tr></table></div></p>
...
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 24px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">-</td><td>Ссылка на размеры массива динамичекси в DSQL</td></tr></table></div>
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 24px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">-</td><td>Установка элемента массива в NULL</td></tr></table></div>
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 24px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">-</td><td>Использование аггрегативных функций, таких как min(), max(), с массивами.</td></tr></table></div>
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 24px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">-</td><td>Ссылка на массивыв GROUP BY</td></tr></table></div>
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 24px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">-</td><td>Создание представлений которые производят выборку из секторов массива</td></tr></table></div>
<p>Чтение данных из массива</p>
<p>Есть 7 шагов для чтения данных из массива или сектора массива:</p>
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 24px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">1.</td><td>Создание инструкции SELECT, которая выбирает соответствущий столбец</td></tr></table></div>
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 24px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">2.</td><td>Подготовка структуры вывода XSQLDA для хранения данных столбца для каждой выбраной строки</td></tr></table></div>
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 24px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">3.</td><td>Подготовка инструкции SELECT для выполнения</td></tr></table></div>
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 24px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">4.</td><td>Выполнение инструкции</td></tr></table></div>
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 24px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">5.</td><td>Заполнение дескриптора массива информацией о описывающей массив или сетор массива для выборки</td></tr></table></div>
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 24px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">6.</td><td>Выбираем отобранные строки по одной</td></tr></table></div>
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 24px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">7.</td><td>Читаем и обрабатываем массив данных из каждой строки</td></tr></table></div>
...
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 24px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">-</td><td>Определяем тип столбца (если он не был установлен isc_dsql_prepare())</td></tr></table></div>
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 24px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">-</td><td>Уквзатель sqldata  связывает с локальными переменными</td></tr></table></div>
...
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 24px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">1.</td><td>Подготовка дескриптора с информацией описывающей массив (или сектор) для записи</td></tr></table></div>
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 24px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">2.</td><td>Подготовка буфера массива с данными для записи.</td></tr></table></div>
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 24px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">3.</td><td>Подготовка соответствующей DSQL инструкции.</td></tr></table></div>
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 24px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">4.</td><td>Вызовите isc_array_put_slice() для создание нового массива, и для записи данных из буфера массива в массив или сектор массива</td></tr></table></div>
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 24px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">5.</td><td>Свяжите новый массив со столбцом массива, установив его значение к ID массива</td></tr></table></div>
...
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 24px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">1.</td><td>Удалите строку содержащую массив обычной инструкцией DELETE</td></tr></table></div>
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 24px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">2.</td><td>Замените массив други, как описано выше. Если массив столбец содержит ID массива, и вы модифицируете столбец  ссылкой на другой массив, то массив со старым ID будет удален во время следующей сборки “мусора”.</td></tr></table></div>
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 24px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">3.</td><td>Сьросьте в NULL столбец ссылающийся на массив. Например, используя DSQL инструкцию:</td></tr></table></div>
<p>"UPDATE JOB SET LANGUAGE_REQ = NULL \</p>
...
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 24px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">-</td><td>Ядра InterBase, которое обслуживает очередь событий и уведомляет приложения, когда событие происходит.</td></tr></table></div>
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 24px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">-</td><td>Буфера параметров событий, созданного приложением, где оно может получать уведомление о событиях .</td></tr></table></div>
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 24px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">-</td><td> Приложение, которое регистрирует   одно или несколько интересующих определенных, именованных событиямй и  ждет уведомление, когда произойдет синхронное событие, или передает указатель на функцию AST, которая обрабатывает уведомления так, чтобы работа приложения могла продолжаться (асинхронное событие).</td></tr></table></div>
...
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 24px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="29">1.</td><td>Первый байт определяет что за параметр будет описан в кластере.</td></tr></table></div>
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 24px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="29">2.</td><td>Второй байт определяет длину описфываемого параметра</td></tr></table></div>
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 24px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="29">3.</td><td>Дальше идет столько байт сколько определил  второй байт кластера.</td></tr></table></div>
