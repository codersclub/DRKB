<h1>Пример Drag &amp; Drop между двумя TDBGrid</h1>
<div class="date">01.01.2007</div>


<p>Данный пример компонента и демонстрационный проект показывают простой путь осуществления операции "drag and drop" (перетащи и брось) между двумя полями различных табличных сеток.</p>
