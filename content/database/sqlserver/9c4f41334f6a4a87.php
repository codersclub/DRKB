<h1>Extended Stored Procedures with Delphi &ndash; Using the ODS (Open Data Services) API from Delphi</h1>
...
<p>As a special bonus, this article also is a simple solution to encrypting your data inside SQL Server using Extended Stored Procedures.</p>
...
<p>4. In the Unit file just under the Uses clause add your function reference:</p>
...
<p>NOTE: There are a number of things you can do with ODS. This is just an example for Delphi. You can read the ODS help in MSDN and do even more.</p>

<p>6. Testing and Debugging:</p>
...
<p>-------------------------------------------------------</p>
<p>End of article. Bellow follows a unit required for ODS.</p>
<p>-------------------------------------------------------</p>

<p>MsOdsApi.pas (Copy from line below)</p>
