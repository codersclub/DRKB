...
<table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>TAPE - определяет запись о кассете;</td></tr></table></div><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>RUSSIANTITLE - название фильма в русскоязычном прокате;</td></tr></table></div><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>ORIGINALTITLE - оригинальное название фильма;</td></tr></table></div><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>COUNTRY - страна - производитель фильма;</td></tr></table></div><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>YEAR - год выпуска;</td></tr></table></div><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>TIME - длительность фильма;</td></tr></table></div><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>DIRECTOR - режиссер;</td></tr></table></div><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>STARRINGLIST - список актеров;</td></tr></table></div><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>ACTOR - имя актера, из списка актеров;</td></tr></table></div><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>CATEGORY - жанр;</td></tr></table></div><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>RATING - оценка;</td></tr></table></div><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>COMMENTS - комментарий к фильму.</td></tr></table></div>Примером описания одного фильма на XML при использовании нашего словаря будет:</p>
...
<table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>запятая (,) - разделяет типы элементов в списке или последовательности;</td></tr></table></div><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>вертикальная черта (|) - разделяет элементы в списке;</td></tr></table></div><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>плюс (+) - указывает, что элемент будет использоваться один или более раз;</td></tr></table></div><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>вопросительный знак (?) - указывает, что элемент не будет использоваться или будет использоваться один раз;</td></tr></table></div><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>звездочка (*) - указывает, что элемент не будет использоваться или будет использоваться несколько раз.</td></tr></table></div>Примером может служить конструкция списка &lt;OL&gt; в HMTL, описание которой выглядело бы следующим образом:</p>
<pre>
&lt;!ELEMENT OL (LI+)&gt;
</pre>
...
<table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>простой текст - CDATA;</td></tr></table></div><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>уникальный идентификатор - ID;</td></tr></table></div><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>предопределенные значения - (значение|значение|...);</td></tr></table></div><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>нетекстовый объект - ENTITY.</td></tr></table></div>&nbsp;</p>
Тип атрибута описывается следующими ключевыми словами:</p>
<table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>обязательный - #REQUIRED;</td></tr></table></div><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>фиксированный - #FIXED;</td></tr></table></div><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>неявный - #IMPLIED.</td></tr></table></div>Например, сокращенный вариант описания атрибутов элемента HTML &lt;IMG&gt; выглядел бы следующим образом:</p>
<pre>
&lt;!ATTLIST IMG
SRC ENTITY #IMPLIED
ALT CDATA #IMPLIED
