...
<p>Данная статья не является каким-либо учебным пособием, а просто попыткой обобщить некий опыт, полученный в течение некоторого времени при использовании ADO.</p>
...
<p>Введем туда какие-либо данные (абсолютно все равно какие). Только надо учесть, что в силу специфики работы у нас могут быть описания, которым пока объекты не соответствуют. Такая связка будет выполнена позже пользователем. Ну, попробуем вывести содержимое таблицы в DBGrid. Ага, получилось. Например, как на картинке:</p>
<p>
<img src="/pic/clip0291.gif" width="393" height="178" border="0" alt="clip0291">
<br>
...
<p>
<img src="/pic/clip0292.gif" width="509" height="117" border="0" alt="clip0292">
</p>
...
<p><img src="/pic/clip0293.gif" width="346" height="226" border="0" alt="clip0293"></p>
...
<p><img src="/pic/clip0294.gif" width="323" height="228" border="0" alt="clip0294"></p>
...
ALTER TABLE название_таблицы ADD CONSTRAINT имя_ограничения
  PRIMARY KEY(название_поля)
</pre>
...
<p>
<img src="/pic/clip0295.gif" width="565" height="134" border="0" alt="clip0295">
<br>
Неправильных символов нет, синтаксис правильный, длина названия ключа тоже нормальная. Я так думаю потому, что если выполнить это через BDE, все будет работать со свистом.</p>
...
<p>Кстати, по моему опыту удалить однажды созданный первичный ключ для таблицы невозможно.</p>
...
<img src="/pic/clip0296.gif" width="565" height="138" border="0" alt="clip0296">

<p>Ага, хорошо, давайте попробуем указать таблицу в пути:</p>
...
<img src="/pic/clip0297.gif" width="355" height="143" border="0" alt="clip0297">

<p>Ага, стало быть, файл для экспорта должен уже существовать? Ладно, не проблема, давайте создадим его и попробуем еще раз.</p>

<img src="/pic/clip0298.gif" width="439" height="133" border="0" alt="clip0298">
...
<p>Вот, в общем-то, все, что я хотел написать. Осталось еще много интересного в этой области. Чего стоит, например установка правильных кодовых страниц для результирующих файлов и много чего подобного. Это тема либо для продолжений этой статьи, либо для отдельных статей. Очень надеюсь, что кто-нибудь нашел тут полезные для себя сведения.</p>

<p>При написании статьи использовались следующие материалы:</p>
<p>
1. Материалы Королевства Delphi.<br>
2. Справочные файлы Delphi 4 и Delphi 5.<br>
3. Исходные коды VCL Delphi 4 и Delphi 5.<br>
4. MS ADO SDK и примеры MS ADO SDK.<br>
5. MS MSDN.<br>
6. А.Я. Архангельский 'Язык SQL в Delphi 5'.<br>
7. &copy;Drkb::02674
</p>
