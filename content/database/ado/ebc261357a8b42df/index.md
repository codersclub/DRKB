...
![](/pic/embim1714.png){width="284" height="74"}
...
![](/pic/embim1715.png){width="300" height="129"}
...
![](/pic/embim1716.png){width="222" height="279"}
...
![](/pic/embim1717.png){width="218" height="270"}
...
![](/pic/embim1718.png){width="222" height="279"}
...
![](/pic/embim1719.png){width="218" height="270"}
...
![](/pic/embim1720.png){width="248" height="311"}
...
![](/pic/embim1721.png){width="197" height="176"}
...
Теперь нам необходимо указать базу данных. Делается это в свойстве
...
После этого в свойстве TableName компонента TADOTable выберем таблицу
customer.
...
![](/pic/embim1722.png){width="347" height="209"}
...
![](/pic/embim1723.png){width="353" height="221"}
...
![](/pic/embim1724.png){width="247" height="294"}
...
компонентах MasterSQL и DetailSQL. После нажатия на кнопку «...»
появится редактор компонент, который выглядит следующим образом

![](/pic/embim1725.png){width="355" height="233"}
...
IlUnspecified         Сервер будет использовать лучший, по его мнению,
тип изоляции.        

IlChaos         Транзакции с более высоким уровнем изоляции не могут
изменять данные измененные, но не подтвержденные в текущей транзакции.  
     

IlReadUncommitted        Чтение данных измененных в не подтвержденных
...
IlReadCommitted        Чтение данных измененных подтвержденными
...
IlRepeatableRead        Изменения, сделанные другими транзакциями не
видимы, но при выполнении перезапроса они транзакция может получать
новый набор данных.        

IlIsolated        Транзакция не видит изменений данных произведенных
...
ctUnspecified -- библиотека ADO сама определяет оптимальный тип
блокировки.
...
ltUnspecified -- библиотека ADO сама определяет какой тип будет
использоваться.

ltReadOnly -- только чтение, изменение данных невозможно.

ltPessimistic -- пессимистическая блокировка. Запись блокируется сразу
после начала редактирования и до сохранения записей.

ltOptimistic -- оптимистическая блокировка. Запись блокируется только
когда изменения сохраняются.
...
OnFetchProgress -- многократно вызывается в процессе выборки набора
данных.
