...
<p>Обучающее руководство по PostgreSQL</p>
<p>Команда разработчиков PostgreSQL</p>
<p>Под редакцией</p>
<p>Thomas Lockhart</p>
Авторское право на PostgreSQL принадлежит Postgres Global Development Group</p>
...
<p>Нотация </p>
<p>О Y2K </p>
<p class="author">Авторские права и торговые марки </p>
