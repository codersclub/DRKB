...
<p>Математические основы реляционных СУБД</p>
Понятие отношения. Основные операции. Реляционная алгебра и реляционное исчисление. Понятие о нормализации. Первая, вторая, третья и четвертая нормальные формы.</p>
4.1. Основные понятия</p>
...
-----------T--------------------------T-----------------+ <br>
¦&nbsp; Товар&nbsp;&nbsp; ¦ производитель&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ¦ Адрес&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ¦<br>
+----------+--------------------------+-----------------+<br>
¦&nbsp; рога&nbsp;&nbsp;&nbsp; ¦ АО Рога и Копыта&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ¦ Одесса, п/я 13&nbsp; ¦<br>
¦&nbsp; копыта&nbsp; ¦ АО Рога и Копыта&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ¦ Одесса, п/я 13&nbsp; ¦<br>
¦&nbsp; кеды&nbsp;&nbsp;&nbsp; ¦ АО Рога и Копыта&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ¦ Одесса, п/я 13&nbsp; ¦<br>
¦&nbsp; джинсы&nbsp; ¦ ТОО Добро пожаловать&nbsp;&nbsp;&nbsp;&nbsp; ¦ Энск, 5-е авеню ¦<br>
<p>L----------+--------------------------+------------------</p>
Рис. 4.1. Пример таблицы “Товары”.</p>
Отметим еще раз, что, так как атрибуты именованы, и порядок записей в таблице не важен, можно поменять порядок столбцов и строк, а таблица с точки зрения реляционной модели останется той же самой:</p>
+--------------------------T---------T ----------------+ <br>
¦ производитель&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ¦ Товар&nbsp;&nbsp; ¦ Адрес&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ¦<br>
+--------------------------+---------+-----------------+<br>
¦ АО Рога и Копыта&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ¦ кеды&nbsp;&nbsp;&nbsp; ¦ Одесса, п/я 13&nbsp; ¦<br>
¦ АО Рога и Копыта&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ¦ копыта&nbsp; ¦ Одесса, п/я 13&nbsp; ¦<br>
¦ ТОО Добро пожаловать&nbsp;&nbsp;&nbsp;&nbsp; ¦ джинсы&nbsp; ¦ Энск, 5-е авеню ¦<br>
¦ АО Рога и Копыта&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ¦ рога&nbsp;&nbsp;&nbsp; ¦ Одесса, п/я 13&nbsp; ¦<br>
<p>L--------------------------+---------+------------------</p>
Рис. 4.2. Другой вариант представления таблицы “Товары” из рисунка 4.1.</p>
4.2. Ключи</p>
...
---------T----------T ----------------------T-----------------+ <br>
¦ Товар&nbsp; ¦ Бар-код&nbsp; ¦ производитель&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ¦ Адрес&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ¦<br>
+--------+----------+----------------------+-----------------+<br>
¦ рога&nbsp;&nbsp; ¦ 46131313 ¦ АО Рога и Копыта&nbsp;&nbsp;&nbsp;&nbsp; ¦ Одесса, п/я 13&nbsp; ¦<br>
¦ копыта ¦ 46061235 ¦ АО Рога и Копыта&nbsp;&nbsp;&nbsp;&nbsp; ¦ Одесса, п/я 13&nbsp; ¦<br>
¦ кеды&nbsp;&nbsp; ¦ 01000004 ¦ АО Рога и Копыта&nbsp;&nbsp;&nbsp;&nbsp; ¦ Одесса, п/я 13&nbsp; ¦<br>
¦ джинсы ¦ 02000551 ¦ ТОО Добро пожаловать ¦ Энск, 5-е авеню ¦<br>
<p>L--------+----------+----------------------+------------------</p>
Рис. 4.3. Модифицированная таблица “Товары”.</p>
...
---------T----------T ----------------------T-----------------+ <br>
¦ Товар&nbsp; ¦ id&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ¦ Производитель&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ¦ Адрес&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ¦<br>
+--------+----------+----------------------+-----------------+<br>
¦ рога&nbsp;&nbsp; ¦ #105&nbsp;&nbsp;&nbsp;&nbsp; ¦ АО Рога и Копыта&nbsp;&nbsp;&nbsp;&nbsp; ¦ Одесса, п/я 13&nbsp; ¦<br>
¦ копыта ¦ #106&nbsp;&nbsp;&nbsp;&nbsp; ¦ АО Рога и Копыта&nbsp;&nbsp;&nbsp;&nbsp; ¦ Одесса, п/я 13&nbsp; ¦<br>
¦ кеды&nbsp;&nbsp; ¦ #214&nbsp;&nbsp;&nbsp;&nbsp; ¦ АО Рога и Копыта&nbsp;&nbsp;&nbsp;&nbsp; ¦ Одесса, п/я 13&nbsp; ¦<br>
¦ джинсы ¦ #157003&nbsp; ¦ ТОО Добро пожаловать ¦ Энск, 5-е авеню ¦<br>
<p>L--------+----------+----------------------+------------------</p>
Рис. 4.4. Таблица “Товары” с введеным искусственным ключом.</p>
...
4.3. Основные операции над таблицами и их интерпретация</p>
...
+----------------------T-----------------+ <br>
¦ Производитель&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ¦ Адрес&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ¦<br>
+----------------------+-----------------+<br>
¦ АО Рога и Копыта&nbsp;&nbsp;&nbsp;&nbsp; ¦ Одесса, п/я 13&nbsp; ¦<br>
¦ ТОО Добро пожаловать ¦ Энск, 5-е авеню ¦<br>
<p>+----------------------+-----------------+</p>
Рис. 4.5. Проекция таблицы “Товары” для получения списка фирм-производителей.</p>
...
¦&nbsp; кеды&nbsp;&nbsp;&nbsp; ¦ АО Рога и Копыта&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ¦ Одесса, п/я 13&nbsp; ¦<br>
<p>L----------+--------------------------+------------------</p>
Рис. 4.6. Селекция таблицы “Товары” по условию.</p>
...
+----------------------T-----------------+ <br>
¦ Потребитель&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ¦ Адрес&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ¦<br>
+----------------------+-----------------+<br>
¦ ЗАО Антилопа Гну&nbsp;&nbsp;&nbsp;&nbsp; ¦ Приморск, Остапу¦<br>
¦ ТОО Добро пожаловать ¦ Энск, 5-е авеню ¦<br>
<p>+----------------------+-----------------+</p>
...
¦ ТОО Добро пожаловать ¦ Энск, 5-е авеню ¦<br>
<p>+----------------------+-----------------+</p>
Рис. 4.8. Объединение двух таблиц.</p>
...
¦&nbsp; рога&nbsp;&nbsp;&nbsp; ¦ АО Рога и Копыта&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ¦ Одесса, п/я 13&nbsp; ¦<br>
¦&nbsp; кеды&nbsp;&nbsp;&nbsp; ¦ АО Рога и Копыта&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ¦ Одесса, п/я 13&nbsp; ¦<br>
¦&nbsp; рога&nbsp;&nbsp;&nbsp; ¦ ТОО Добро пожаловать&nbsp;&nbsp;&nbsp;&nbsp; ¦ Энск, 5-е авеню ¦<br>
¦&nbsp; кеды&nbsp;&nbsp;&nbsp; ¦ ТОО Добро пожаловать&nbsp;&nbsp;&nbsp;&nbsp; ¦ Энск, 5-е авеню ¦<br>
<p>L----------+--------------------------+------------------</p>
Рис. 4.9. Декартово произведение двух таблиц.</p>
...
----T--------T--------T--------T--------T--------T-----T---------¬ <br>
¦ N ¦Фамилия ¦дата&nbsp;&nbsp;&nbsp; ¦месяц,&nbsp; ¦месячная¦ дата&nbsp;&nbsp; ¦отдел¦должность¦<br>
¦&nbsp;&nbsp; ¦&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ¦рожден. ¦год&nbsp;&nbsp;&nbsp;&nbsp; ¦зарплата¦ приема ¦&nbsp;&nbsp;&nbsp;&nbsp; ¦&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ¦<br>
+---+--------+--------+--------+--------+--------+-----+---------+<br>
¦ 1 ¦ Иванов ¦1.1.1955¦12,1994 ¦ 150000 ¦2.2.1986¦ОНТИ ¦инженер&nbsp; ¦<br>
¦ 2 ¦ Петров ¦3.4.1966¦11.1994 ¦ 280000 ¦4.9.1992¦ВОХР ¦охранник ¦<br>
¦ 3 ¦ Петров ¦3.4.1966¦12,1994 ¦ 350000 ¦4.9.1992¦ВОХР ¦охранник ¦<br>
¦ 4 ¦ Сидоров¦7.1.1968¦12,1994 ¦ 350000 ¦1.7.1989¦ВОХР ¦охранник ¦<br>
¦.. ¦&nbsp;&nbsp; .... ¦ ....&nbsp;&nbsp; ¦ ....&nbsp;&nbsp; ¦ ....&nbsp;&nbsp; ¦ ....&nbsp;&nbsp; ¦.... ¦ ....&nbsp;&nbsp;&nbsp; ¦<br>
<p>L---+--------+--------+--------+--------+--------+-----+----------</p>
Рис. 4.10. Пример ненормализованеной таблицы.</p>
...
Под жесткостью понимается обязательная модификация самой таблицы при изменении постановки задачи. Например, если потребовалось хранить количество детей и их возраст, то потребуется модифицировать структуру таблицы,</p>
...
Рассмотрим подробно недостатки такой схемы.</p>
...
-----------T--------------------------T-----------------¬ <br>
¦&nbsp; рога&nbsp;&nbsp;&nbsp; ¦ АО Рога и Копыта&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ¦ Москва, Бутырка ¦<br>
¦&nbsp; копыта&nbsp; ¦ АО Рога и Копыта&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ¦ Одесса, п/я 13&nbsp; ¦<br>
¦&nbsp; кеды&nbsp;&nbsp;&nbsp; ¦ АО Рога и Копыта&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ¦ Одесса, п/я 13&nbsp; ¦<br>
¦ ......&nbsp;&nbsp; ¦ ....................&nbsp;&nbsp;&nbsp;&nbsp; ¦ ............... ¦<br>
<p>L----------+--------------------------+------------------</p>
Рис. 4.12. Последствия неполного обновления данных в ненормализованной таблице.</p>
Этот недостаток опасен с точки зрения поддержания целостности, непротивноречивости данных в базе данных. Такое рассогласование в реальной жизни, случившееся по причине случайной ошибки программиста или оператора может служить причиной неоплаченных поставок, штрафных санкций и т.д.</p>
...
+--------+----------+----------------------+-----------------+<br>
¦ рога&nbsp;&nbsp; ¦ 46131313 ¦ АО Рога и Копыта&nbsp;&nbsp;&nbsp;&nbsp; ¦ Одесса, п/я 13&nbsp; ¦<br>
¦ копыта ¦ 46131235 ¦ АО Рога и Копыта&nbsp;&nbsp;&nbsp;&nbsp; ¦ Одесса, п/я 13&nbsp; ¦<br>
¦ кеды&nbsp;&nbsp; ¦ 01130004 ¦ АО Рога и Копыта&nbsp;&nbsp;&nbsp;&nbsp; ¦ Одесса, п/я 13&nbsp; ¦<br>
¦ кеды&nbsp;&nbsp; ¦ 01130006 ¦ АО Рога и Копыта&nbsp;&nbsp;&nbsp;&nbsp; ¦ Одесса, п/я 13&nbsp; ¦<br>
¦ джинсы ¦ 02010551 ¦ ТОО Добро пожаловать ¦ Энск, 5-е авеню ¦<br>
¦ кеды&nbsp;&nbsp; ¦ 02010552 | ТОО Добро пожаловать ¦ Энск, 5-е авеню ¦<br>
| ...&nbsp;&nbsp;&nbsp; | ...&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | ...&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | ...&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; |<br>
<p>L--------+----------+----------------------+------------------</p>
...
Таблица “Товары”<br>
---------T----------------------+<br>
¦ Товар&nbsp; ¦ производитель&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ¦<br>
+--------+----------------------+<br>
¦ рога&nbsp;&nbsp; ¦ АО Рога и Копыта&nbsp;&nbsp;&nbsp;&nbsp; ¦<br>
¦ копыта ¦ АО Рога и Копыта&nbsp;&nbsp;&nbsp;&nbsp; ¦<br>
¦ кеды&nbsp;&nbsp; ¦ АО Рога и Копыта&nbsp;&nbsp;&nbsp;&nbsp; ¦<br>
¦ джинсы ¦ ТОО Добро пожаловать ¦<br>
¦ кеды&nbsp;&nbsp; ¦ ТОО Добро пожаловать ¦<br>
| ...&nbsp;&nbsp;&nbsp; | ...&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; |<br>
<p>L--------+----------------------+</p>
...
Выделение отдельной таблицы для хранения адресов производителей (а, в более общем случае, для хранения любых атрибутов, специфичных для конкретной фирмы) позволит избежать аномалий вставки и удаления, повысить надежность системы и снизить затраты на хранение данных. А именно:</p>
<div style="text-align: justify; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 8px 0px 8px 0px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr ><td width="19">&#183;</td><td>можно хранить информацию о фирме, которая в данный момент ничего для нас не производит, но собирается начать это делать;</td></tr></table></div><div style="text-align: justify; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 8px 0px 8px 0px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr ><td width="19">&#183;</td><td>удаление всех записей о товарах, производимых некоторой фирмой, не приведет к автоматической потери всей информации о данной фирме;</td></tr></table></div><div style="text-align: justify; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 8px 0px 8px 0px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr ><td width="19">&#183;</td><td>при изменении адреса у фирмы это потребуется сделать только в одном месте, если бы мы не разделили отношение на два, то такое изменение потребовалось бы сделать для каждой записи о товаре. Это повышает надежность системы и повышает скорость обработки подобных запросов;</td></tr></table></div><div style="text-align: justify; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 8px 0px 8px 0px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr ><td width="19">&#183;</td><td>адрес для каждой фирмы хранится в одном месте, дублирование же этой информации приводит к неоправданному расходу памяти.</td></tr></table></div>Третья нормальная форма</p>
...
+--------+----------------------+--------+<br>
¦ Город&nbsp; ¦ Улица&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ¦ Индекс ¦<br>
+--------+----------------------+--------+<br>
¦ Москва ¦ Профсоюзная&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ¦ 116321 ¦<br>
¦ Москва ¦ Островитянова&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ¦ 116321 ¦<br>
¦ Москва ¦ Академическая&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ¦ 117303 ¦<br>
¦ Дмитров¦ Профсоюзная&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ¦ 157400 ¦<br>
¦ Клин&nbsp;&nbsp; ¦ Профсоюзная&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ¦ 190005 ¦<br>
¦ Клин&nbsp;&nbsp; ¦ Абрикосовая&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ¦ 190006 ¦<br>
| ...&nbsp;&nbsp;&nbsp; | ...&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | ...&nbsp;&nbsp;&nbsp; |<br>
<p>L--------+----------------------+--------+</p>
Рис. 4.17. Таблицы “Почтовые индексы”.</p>
Следовательно, данная таблица не находится в нормальной форме Бойса-Кодда.</p>
...
<div style="text-align: justify; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 8px 0px 8px 0px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr ><td width="19">1.</td><td>r3 совпадает на множестве атрибутов X с записями r1 и r2, то есть r1[X]=r2[X]=r3[X], </td></tr></table></div><div style="text-align: justify; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 8px 0px 8px 0px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr ><td width="19">2.</td><td>на множестве атрибутов Y запись r3 совпадает с r1, то есть r1[Y]=r3[Y],</td></tr></table></div><div style="text-align: justify; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 8px 0px 8px 0px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr ><td width="19">3.</td><td>на множестве атрибутов, не входящих ни в X, ни в Y , запись r3 совпадает с r2, то есть r2[R-(X+Y)]=r3[R-(X+Y)].</td></tr></table></div>Если попытатьться перефразировать это определение, то можно пояснить его смысл следующим образом: Если существует запись [x, y1, z1] и запись [x, y2, z2], то должна существовать запись [x, y1, z2] и (в силу симметричности определения) запись [x, y2, z1]. Многозначные зависимости проявляются при логическом группировании некоторых атрибутов, и их симметричном вхождении в отношении. Например, рассмотрим таблицу, в которой хранится информация о семинарах, проводимых в некотором Университете. Данная таблица может иметь следующие атрибуты:</p>
+---------------+----------+-----------+--------+--------+<br>
¦ Преподаватель ¦ Студент&nbsp; ¦ Аудитория | Время&nbsp; ¦ День&nbsp;&nbsp; ¦<br>
+---------------+----------+-----------+--------+--------+<br>
¦ Бякин&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ¦ Петров&nbsp;&nbsp; ¦ 711&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; |&nbsp; 9:00&nbsp; ¦ Понед&nbsp; ¦<br>
¦ Бякин&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ¦ Иванова&nbsp; ¦ 745&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | 10:50&nbsp; ¦ Понед&nbsp; ¦<br>
| ...&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | ...&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | ...&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | ...&nbsp;&nbsp;&nbsp; |&nbsp; ...&nbsp;&nbsp; ¦<br>
<p>L---------------+----------+-----------+--------+--------+</p>
Рис. 4.18. Таблица “Семинары”.</p>
Если предположить, что студенты Петров и Иванова учатся в одной группе, то, следовательно, они ходят на одни и те же занятия (болезни и прогулы для простоты не рассматриваются). Следовательно, в данной таблице должны быть и следующие записи:</p>
7+---------------+----------+-----------+--------+--------+<br>
¦ Преподаватель ¦ Студент&nbsp; ¦ Аудитория | Время&nbsp; ¦ День&nbsp;&nbsp; ¦<br>
+---------------+----------+-----------+--------+--------+<br>
¦ Бякин&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ¦ Петров&nbsp;&nbsp; ¦ 711&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; |&nbsp; 9:00&nbsp; ¦ Понед&nbsp; ¦<br>
¦ Бякин&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ¦ Иванова&nbsp; ¦ 745&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | 10:50&nbsp; ¦ Понед&nbsp; ¦<br>
¦ Бякин&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ¦ Петров&nbsp;&nbsp; ¦ 745&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | 10:50&nbsp; ¦ Понед&nbsp; ¦<br>
¦ Бякин&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ¦ Иванова&nbsp; ¦ 711&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; |&nbsp; 9:50&nbsp; ¦ Понед&nbsp; ¦<br>
| ...&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | ...&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | ...&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | ...&nbsp;&nbsp;&nbsp; |&nbsp; ...&nbsp;&nbsp; ¦<br>
<p>L---------------+----------+-----------+--------+--------+</p>
Рис. 4.19. Таблица “Семинары” в случае отсутствия 4-й нормальной формы.</p>
В этом случае атрибут “Студент” функционально зависит от атрибута “Преподаватель”.</p>
...
<div style="text-align: justify; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 8px 0px 8px 0px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr ><td width="19">&#183;</td><td>Факт поставки (товар, кто поставил, когда поставил, контракт, условия поставки)</td></tr></table></div><div style="text-align: justify; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 8px 0px 8px 0px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr ><td width="19">&#183;</td><td>Товар (производитель, название)</td></tr></table></div><div style="text-align: justify; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 8px 0px 8px 0px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr ><td width="19">&#183;</td><td>Контракт (кто подписал, что предусматривает, срок действия)</td></tr></table></div><div style="text-align: justify; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 8px 0px 8px 0px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr ><td width="19">&#183;</td><td>Поставщик товара (название, адрес)</td></tr></table></div><div style="text-align: justify; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 8px 0px 8px 0px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr ><td width="19">&#183;</td><td>Производитель товара (название, адрес)</td></tr></table></div>Следующий шаг в построениии схемы базы данных должен заключаться в поиске ключей. Атрибуты, входящие в ключ, должны быть тщательно проанализированы на тот факт, что они действительно всегда однозначно будут идентифицировать реальный объект или сущность. В противном случае, имеет смысл ввести искусственный ключ. Более того, хорошим тоном может считаться обязательное введение искуственного ключа и использование его в качестве первичного для всех (или почти всех) таблиц в базе данных.</p>
Следующий шаг - детальная спецификация атрибутов для таблиц, в том числе, определение доменов, то есть типов данных, которые будут приписаны атрибутам. В нашем случае можно предположить, что схема базы данных будет выглядеть следующим образом (стрелками показаны свяки между таблицами):</p>
Факты_поставки (<br>
 &nbsp;&nbsp; id&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; integer,<br>
 &nbsp;&nbsp; товар&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; integer,&nbsp; -----------+<br>
 &nbsp;&nbsp; поставщик&nbsp;&nbsp; integer,&nbsp; ---------+ |<br>
 &nbsp;&nbsp; дата&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; date,&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | |<br>
 &nbsp;&nbsp; контракт&nbsp;&nbsp;&nbsp; integer)&nbsp; -------+ | |<br>
 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | | |<br>
Товары (&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | | |<br>
 &nbsp;&nbsp; id&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; integer,&nbsp; &lt;--------+<br>
 &nbsp;&nbsp; производитель integer,&nbsp; ---+ | | <br>
 &nbsp;&nbsp; название&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; character)&nbsp;&nbsp; | | | <br>
 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | | | <br>
Контракты (&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | | | <br>
 &nbsp;&nbsp; id&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; integer,&nbsp; &lt;------+ | <br>
 &nbsp;&nbsp; подписал&nbsp;&nbsp;&nbsp; character,&nbsp;&nbsp;&nbsp;&nbsp; |&nbsp;&nbsp; | <br>
 &nbsp;&nbsp; условия&nbsp;&nbsp;&nbsp;&nbsp; character,&nbsp;&nbsp;&nbsp;&nbsp; |&nbsp;&nbsp; | <br>
 &nbsp;&nbsp; срок&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; interval)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; |&nbsp;&nbsp; | <br>
 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; |&nbsp;&nbsp; | <br>
Поставщики (&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; |&nbsp;&nbsp; | <br>
 &nbsp;&nbsp; id&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; integer,&nbsp; &lt;--------+ <br>
...
Фирмы (&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; |&nbsp;&nbsp; | <br>
 ...
 &nbsp;&nbsp; название&nbsp;&nbsp;&nbsp; character,&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <br>
<p> &nbsp;&nbsp; адрес&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; character)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </p>
Общие правила нормализации</p>
Подводя итоги описания методики нормализации, можно выделить следующие правила “хорошего тона”:</p>
<div style="text-align: justify; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 8px 0px 8px 0px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr ><td width="19">1.</td><td>Помни про нормальные формы.</td></tr></table></div><div style="text-align: justify; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 8px 0px 8px 0px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr ><td width="19">2.</td><td>Схема должна соответсвовать реальной предметной области</td></tr></table></div><div style="text-align: justify; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 8px 0px 8px 0px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr ><td width="19">3.</td><td>Атрибуты должны зависеть от ключа, от всего ключа целиком и ни от чего другого, кроме ключа [П.Грей]</td></tr></table></div><div style="text-align: justify; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 8px 0px 8px 0px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr ><td width="19">4.</td><td>Чем меньше зависимостей внутри таблицы, тем лучше.</td></tr></table></div><div style="text-align: justify; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 8px 0px 8px 0px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr ><td width="19">5.</td><td>Естественные ключи на поверку редко оказываются ключами.</td></tr></table></div>При разработке схемы базы данных важно учитывать и мировой опыт в смежных областях, а именно, помнить про следующие правила:</p>
<div style="text-align: justify; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 8px 0px 8px 0px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr ><td width="19">1.</td><td>Не надо плодить сущностей сверх меры [К.Прутков]</td></tr></table></div><div style="text-align: justify; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 8px 0px 8px 0px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr ><td width="19">2.</td><td>Семь раз отмерь, один раз отрежь (семь раз подумай, один раз создай таблицу).</td></tr></table></div><div style="text-align: justify; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 8px 0px 8px 0px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr ><td width="19">3.</td><td>Первый блин комом (первая схема редко бывает удачной).</td></tr></table></div>&nbsp;</p>
