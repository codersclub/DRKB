...
<p>
1. копирование данных из буфера обмена Windows в компонент TDBImage, связанный с BLOB-полем<br>
2. использование метода LoadFromFile компонента TBLOBField<br>
