...
Таблица 10-1: Системные функции, аргументы и результаты
  ...
  Datalength              (выражение)                          Возвращает длину
                                                               выражения в байтах.
                                                               Выражением обычно
                                                               является название
  ...
  rowcnt                  (doampg)                             Возращает число строк в
                                                               таблице.
...
Таблица 10-3: Строковые функции, аргументы и результаты
  ...
  difference               (char\_expr1,           Возвращает целое число,
  ...
  replicate                (char\_expr,            Возвращает строку того
...
::: {style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 0px 113px;"}
  --- ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  ·   Преобразования типа к самому себе, помещены символом "\_". В общем случае SQL Сервер допускает явное преобразование типа к самому себе, но такие преобразования не имют смысла.![](/pic/embim1735.png){width="488" height="461"}
  --- ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
:::
