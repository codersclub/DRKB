<h1>SVR API для непродвинутых</h1>
...
<p>Ну, начали!</p>
<pre>function TForm1.GetComputerNetName: string;
var
...
<pre>function NetShareEnum(const pszServer: PChar; sLevel: SmallInt;
...
<pre>procedure TForm1.FillShareEnum(Items: TStrings);
var
...
<pre>function NetShareGetInfo(const pszServer: PChar; const pszNetName: PChar;
...
<pre>function TForm1.GetShareInfo(ComputerNetName, ResourceNetName: string):
  TShareEvent;
var
...
<pre>procedure TForm1.ConnectAdmin;
var
  CompName: string;
  Res: Integer;
