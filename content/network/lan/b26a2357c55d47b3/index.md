...
function NetShareAdd(ServerName: PChar; Level: Integer; pbBuffer:
Pointer;
...
shi50\_type - тип ресурса, может иметь следующие значения:
...
Все бы хорошо. Но\... Есть одно \"но\". Сетевая машина не покажет Вам
