...
<p>Компонент TNMDayTime</p>
Этот компонент предназначен для получения даты и времени от серверов даты и времени в интернет и интранет в соответствии со стандартом rfc 867, называемым "Протокол времени суток". <br>
&nbsp;<br>
