<h1>Визуальный HTM- редактор своими руками</h1>
...
<pre>procedure tform1.speedbutton2click(sender: tobject);
var
range: ihtmltxtrange;
begin
...
<pre>procedure tform1.speedbutton14click(sender: tobject);
var 
table: htmltable; 
textrange: ihtmltxtrange; 
row: htmltablerow; 
