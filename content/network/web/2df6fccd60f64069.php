...
<table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>Пространство имен в описании ответа (тег &lt; m:getStateNameResponse &gt;) должен совпадать с пространством имен в запросе. В нашем примере пространство имен &#8211; m</td></tr></table></div><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>Имя тега описания ответа формируемся добавлением слова Response к имени вызываемой процедуры. В нашем случае это m:getStateNameResponse</td></tr></table></div><p>Разработка сервера Web Services в Delphi6</p>
