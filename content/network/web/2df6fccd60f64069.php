...
<table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>Легкость восприятия текста запроса человеком (&#171;читабельность&#187;);</td></tr></table></div>
<table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>Наличие парсеров XML, позволяющих достаточно просто осуществлять анализ поступающих сообщений.</td></tr></table></div>
<p>Из недостатков можно отметить больший объем сообщений по сравнению с бинарными форматами представления данных. Ниже представлен пример SOAP запроса:</p>
...
<table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>Пространство имен в описании ответа (тег &lt; m:getStateNameResponse &gt;) должен совпадать с пространством имен в запросе. В нашем примере пространство имен - m</td></tr></table></div>
<table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>Имя тега описания ответа формируемся добавлением слова Response к имени вызываемой процедуры. В нашем случае это m:getStateNameResponse</td></tr></table></div>
<p>Разработка сервера Web Services в Delphi6</p>
...
<table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">1.</td><td>Описание интерфейса сервера, то есть методов, которые будут доступны для вызова клиенту;</td></tr></table></div>
<table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">1.</td><td>Реализация методов сервера;</td></tr></table></div>
<table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">1.</td><td>Создание проекта Delphi и включение в него результатов первых двух шагов.</td></tr></table></div>
<p>Последовательно опишем каждый из этапов.</p>
...
<table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>Invocation реестр знает о том, как создать экземпляр этого класса и его наследников при запросе клиентом вызовов методов интерфейса.</td></tr></table></div>
<table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>Так как класс TinvokableClass наследник TInterfacedObject, то он умеет освободить память в случае, когда число ссылок на него равно 0, что облегчает программисту жизнь.</td></tr></table></div>
<p>Текст модуля реализации представлен ниже, комментарии излишни:</p>
<pre>
unit u_Impl;
...
<table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">1.</td><td>Получение описания интерфейса сервера</td></tr></table></div>
<table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">1.</td><td>Написания кода вызова методов сервера</td></tr></table></div>
