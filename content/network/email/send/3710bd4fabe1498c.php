<h1>Работа через MAPI</h1>
<div class="date">01.01.2007</div>


<p>Работа через MAPI</p>
<p>Пример с delphi.mastak.ru мне понравился(который нашел Song), я решил его сюда скопировать, может кому понадобится:</p>
<pre>
unit Email;
