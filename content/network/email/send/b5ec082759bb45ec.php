...
<p>А это форма для этого примера:</p>
<pre>
object Form1: TForm1
Left = 278
Top = 108
...
<hr />
<p>В следующем примере E-mail отправляется автоматически сразу после нажатия кнопки.</p>
<p>ЗАМЕЧАНИЕ: Вам потребуется компонент 'TNMSMTP'. Этот компонент входит в поставляется с Delphi 4 и 5 и его можно найти на закладке 'Fastnet'.</p>
<pre>
procedure TForm1.Button1Click(Sender: TObject); 
begin 
