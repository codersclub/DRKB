<h1>Методы программрования: переборные алгоритмы</h1>
<div class="date">01.01.2007</div>

<div class="author">Автор: Булычев В.А.</div>

<p><img src="/pic/embim1848.gif" width="1" height="1" vspace="1" hspace="1" border="0" alt=""><br>
