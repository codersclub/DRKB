...
+-----------------------------------+-----------------------------------+
| ![](/pic/embim1870.png){width="63 | Из начального элемента            |
| "                                 | распространяется в 4-х            |
| height="63"}                      | направлениях волна (рис1.).       |
|                                   | Элемент в который пришла волна    |
| Рис 1.                            | образует фронт волны.На рисунках  |
|                                   | цифрами обозначены номера фронтов |
|                                   | волны.                            |
+-----------------------------------+-----------------------------------+
| ![](/pic/embim1871.png){width="10 | Каждый элемент первого фронта     |
| 5"                                | волны является источником         |
| height="105"}Рис2.                | вторичной волны (рис 2.).         |
...
|                                   | text-indent: 0px; padding: 0px 0p |
|                                   | x 0px 0px; margin: 0px 36px 0px 2 |
|                                   | 4px;"}                            |
|                                   |   --- --------------------------- |
|                                   | --------------------------------- |
|                                   | -----------------------------     |
...
|                                   | --------------------------------- |
|                                   | ---------------                   |
|                                   |   ·   При движении от конечного э |
|                                   | лемента к начальному номер фронта |
|                                   |  волны (путевые координаты) должн |
|                                   | ы уменьшатся.                     |
|                                   |   --- --------------------------- |
|                                   | --------------------------------- |
|                                   | --------------------------------- |
...
::: {style="text-align: justify; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 7px 16px 7px 5px;"}
  --- ----------------------------------------------------
...
![](/pic/embim1872.png){width="382" height="434"}

Вид программы на этапе построения препятствия

 

![](/pic/embim1873.png){width="382" height="434"}
