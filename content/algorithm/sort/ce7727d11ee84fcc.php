...
<table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>все узлы имеют глубину k или k-1 - дерево сбалансированное.</td></tr></table></div>
<table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>при этом уровень k-1 полностью заполнен, а уровень k заполнен слева направо, т.е форма пирамиды имеет приблизительно такой вид:<br>
<img src="/pic/clip0147.gif" width="94" height="84" border="0" alt="clip0147"></td></tr></table></div>
<table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>выполняется "свойство пирамиды": каждый элемент меньше, либо равен родителю.</td></tr></table></div>
<p>Как хранить пирамиду? Наименее хлопотно - поместить ее в массив.</p>
...
<table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>в a[0] хранится корень дерева</td></tr></table></div>
<table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>левый и правый сыновья элемента a[i] хранятся, соответственнно, в a[2i+1] и a[2i+2]</p>
</td></tr></table></div>
</td>
</tr>
</table>
...
<table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>никаких дополнительных переменных, нужно лишь понимать схему.</td></tr></table></div>
<table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>узлы хранятся от вершины и далее вниз, уровень за уровнем.</td></tr></table></div>
<table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>узлы одного уровня хранятся в массиве слева направо.</td></tr></table></div>
<p>Запишем в виде массива пирамиду, изображенную выше.. Слева-направо, сверху-вниз: 94 67 18 44 55 12 06 42. На рисунке место элемента пирамиды в массиве обозначено цифрой справа-вверху от него.</p>
...
<table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">1.</td><td>Смотрим на сыновей слева и справа - в массиве это a[2i+1] и a[2i+2] и выбираем наибольшего из них.</td></tr></table></div>
<table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">1.</td><td>Если этот элемент больше a[i] - меняем его с a[i] местами и идем к шагу 2, имея в виду новое положение a[i] в массиве. Иначе конец процедуры.</td></tr></table></div>
<p>Новый элемент "просеивается" сквозь пирамиду.</p>
<pre>
template&lt;class T&gt;
...
<table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">1.</td><td>Берем верхний элемент пирамиды a[0]...a[n] (первый в массиве) и меняем с последним местами. Теперь "забываем" об этом элементе и далее рассматриваем массив a[0]...a[n-1]. Для превращения его в пирамиду достаточно просеять лишь новый первый элемент.</td></tr></table></div>
<table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">1.</td><td>Повторяем шаг 1, пока обрабатываемая часть массива не уменьшится до одного элемента.</td></tr></table></div>
<img src="/pic/clip0151.gif" width="561" height="494" border="0" alt="clip0151"></p>
