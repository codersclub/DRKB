...
::: {style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 7px 0px 7px 24px;"}
  ...
  ·   при этом уровень k-1 полностью заполнен, а уровень k заполнен слева направо, т.е форма пирамиды имеет приблизительно такой вид:\
      ![clip0147](/pic/clip0147.gif){width="94" height="84"}
...
+-----------------------------------+-----------------------------------+
| ![clip0148](/pic/clip0148.gif){wi | Соответствие между геометрической |
| dth="282"                         | структурой пирамиды как дерева и  |
| height="209"}                     | массивом устанавливается по       |
|                                   | следующей схеме:                  |
|                                   |                                   |
|                                   | ::: {style="text-align: left; tex |
|                                   | t-indent: 0px; padding: 0px 0px 0 |
|                                   | px 0px; margin: 7px 0px 7px 24px; |
|                                   | "}                                |
|                                   |   --- --------------------------- |
|                                   | ------                            |
|                                   |   ·   в a\[0\] хранится корень де |
|                                   | рева                              |
|                                   |   --- --------------------------- |
|                                   | ------                            |
|                                   | :::                               |
...
|                                   | --------------------------------- |
|                                   | -------------------------------   |
|                                   |   ·   левый и правый сыновья элем |
|                                   | ента a\[i\] хранятся, соответстве |
|                                   | ннно, в a\[2i+1\] и a\[2i+2\]     |
|                                   |   --- --------------------------- |
|                                   | --------------------------------- |
|                                   | -------------------------------   |
|                                   | :::                               |
...
следующее характеристическое свойство: a\[i\] \>= a\[2i+1\] и a\[i\] \>=
a\[2i+2\].
...
достаточно вспомнить схему хранения и нарисовать, начиная от корня.
 ...
 \
Фаза 1 сортировки: построение пирамиды ![](/pic/embim1833.gif){width="1"
height="1"}\
![](/pic/embim1834.png){width="160" height="1"}\
 \
...
// вызвать downheap O(n) раз для преобразования массива в пирамиду
целиком
...
![clip0149](/pic/clip0149.gif){width="626" height="458"}\
![clip0150](/pic/clip0150.gif){width="339" height="216"}

 

 \
Фаза 2: собственно сортировка ![](/pic/embim1835.gif){width="1"
height="1"}\
![](/pic/embim1836.png){width="160" height="1"}\
 \
...
![clip0151](/pic/clip0151.gif){width="561" height="494"}
...
упорядоченная последовательность.
      ...
      94  67  18  44  55  12  06  42  //       иллюстрация 2-й фазы
сортировки
