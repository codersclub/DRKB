...
<table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>Массив 1 содержит текущий кадр пламени.</td></tr></table></div>
<table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>Создаем в массиве 1 внизу случайные очаги ( просто ставим точки)</td></tr></table></div>
<table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>Каждый элемент массива 2 получаем как усреденную сумму, соответствующих элементов окружающий данный в массиве 1</td></tr></table></div>
<table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>Массив 2 копируем на экран</td></tr></table></div>
<table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>Переносим массив 2 в массив 1</td></tr></table></div>
<table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>Переход на начало</td></tr></table></div>
<p>Для программы требуется модуль demovga.pas</p>
<pre>
{.$DEFINE DEBUG} 
Program Fire; 
