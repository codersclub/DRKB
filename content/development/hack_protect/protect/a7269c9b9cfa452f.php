...
<p>Поймите, неважно, где хранится ключ. Во внешней микросхеме или в голове покупателя. Помните, покупателем может оказаться и хакер. ВСЕГДА ДОСТАТОЧНО ОДНОГО ЭКЗЕМПЛЯРА ИНСТАЛЯТОРА, чтобы начать штамповку болванок и гнать их за 65 рублей. Я, наверно, плохо объясняю? Ну, тогда сами придумайте себе причину, почему АКМ больше не будет писать про АППАРАТНУЮ ЗАЩИТУ.</td></tr></table></div>
<p class="p_Heading1">ТЕМА "Антиотладочные приемы или слышать об этом больше не хочу"</p>
<table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">1.</td><td>Флаг трассировки. Суть: сброс флага TF в регистре состояний процессора посредством команд ассемблера POPF или IRET. Изжил себя увеличением возможностей процессора к отладке, а также понятием "Виртуальная машина".</td></tr></table></div>
...
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 7px 0px 7px 72px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>Вешание декодера кода или данных на INT 3.</td></tr></table></div>
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 7px 0px 7px 72px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>Постоянный подсчет CRC суммы процедуры, чтобы не вставлялся 0xCC.</td></tr></table></div>
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 7px 0px 7px 72px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>Разброс по программе большого количества 0xCC.</td></tr></table></div>
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 7px 0px 7px 72px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>Чтение адресов обработчиков прерываний и хранение там каких-нить важных переменных.</td></tr></table></div>
<pre>
mov     ah, 25h
mov     al, Int_Number 
...
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 7px 0px 7px 72px;"><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>Сброс отладочных регистров защищенного режима. dr7=0x700 если ICE присутствует. SoftICE перехватывает запись и чтение в/из регистров DR0-DR7. И просто не дает изменить содержимое этих регистров или возвращает 0 или 0х400. Поэтому этот прием не используется, потому что такой код должен быть перенесен в VXD, имеет постоянную сигнатуру и был уже 1.5 года назад предусмотрен в АЙСовых патчах(ловушках).</td></tr></table></div>
<p>Итак - все современные приемы борьбы с отладкой сводятся к обнаружению и уничтожению SoftICE в системе. Сами оценивайте недостатки и преимущества. Да, маленький комент. Когда я буду писать метод устранения, то буду иметь прежде всего обнаружение, т.е. брейк.</p>
