<h1>Время старта и завершения работы системы</h1>
<div class="date">01.01.2007</div>


<p>Вот так можно узнать дату/время загрузки или завершения работы системы (т.е. когда компьютер был выключен или перезагружен последний раз):</p>
<pre>
unit Unit1;
