<h1>Перекодирование из одних кодировок в другие</h1>
<div class="date">01.01.2007</div>


<p>Этот алгоритм позволяет перекодировать текст. </p>
<p>Реализованы кодировки Windows-1251, KOI8-R, ISO-8859-5 и DOS.</p>
<p>Кодировка &#8211; это таблица, в которой указано, </p>
<p>например, что символ под номером 160 - это русская буква "а", а под номером 150 &#8211; "Ц" и т. д.</p>
<p> Кодировки различаются номерами русских букв</p>
<p>  (как располагать английские буквы договорились). </p>
<p>  Разные компьютеры в Интернете используют разные кодировки. </p>
<p>  И поэтому, когда русский текст идет по Интернету, его многократно перекодируют.</p>

<p>Этот алгоритм обеспечивает высокую скорость перекодирования больших объемов данных.</p>
...
<hr />
<p class="p_Heading1">Как можно перекодировать сообщение (содержание) из Win в КОИ8-Р для отправки по EMail? </p>
<p class="p_Heading1">
<pre>
const
...
<hr /><p>Перекодировка текста DOS-Windows-Koi8 </p>
<pre>
procedure WinToDos;
var
  Src, Str: PChar;
...
<hr />
<p>Перекодировка текста из Win1251 в KOI8-R и наоборот </p>
<pre>
type
