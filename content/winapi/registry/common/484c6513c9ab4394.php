<h1>Использование реестра</h1>
<div class="date">01.01.2007</div>

<div class="author">Автор: Алексей Федоров</div>
...
<table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>название подсекции;</td></tr></table></div>
<table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>название элемента;</td></tr></table></div>
<table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>записываемые данные.</td></tr></table></div>
<p>Так, чтобы записать значение элемента MyIntVal в подсекции IntKey, следует выполнить код</p>
