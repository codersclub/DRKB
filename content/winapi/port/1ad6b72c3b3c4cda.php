<h1>Компонент для последовательного устройства (TRS232)</h1>
<div class="date">01.01.2007</div>


<p>Компонент, который представлен здесь, выполняет функции синхронного чтения и записи в последовательный интерфейс RS232.</p>
<p>В цикле выполняется Application.ProcessMessages, чтобы все сообщения от основной программы обрабатывались.</p>
