<h1>Как узнать состояние памяти?</h1>
...
<p>После этого TMemoryStatus будет содержать следующие паоля:</p>
<p>Status.dwMemoryLoad: Количество используемой памяти в процентах (%).</p>
<p>Status.dwTotalPhys: Общее количество физической памяти в байтах.</p>
<p>Status.dwAvailPhys: Количество оставшейся физической памяти в байтах.</p>
<p>Status.dwTotalPageFile: Объём страничного файла в байтах.</p>
<p>Status.dwAvailPageFile: Свободного места в страничном файле.</p>
<p>Status.dwTotalVirtual: Общий объём виртуальной памяти в байтах.</p>
<p>Status.dwAvailVirtual: Количество свободной виртуальной памяти в байтах.</p>
<p>Предваритель, желательно преобразовать эти значения в гига-, мега- или килобайты, например так:</p>
<p>label14.Caption := 'Total Ram: ' + IntToStr(Status.dwTotalPhys div 1024417) + 'meg';</p>
