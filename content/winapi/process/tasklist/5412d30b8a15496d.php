<h1>Как спрятать программу от Task Manager в Windows 2000 и Windows XP?</h1>
<div class="date">01.01.2007</div>


<p>Этот вопрос меня уже достал, он задаётся на всех программистских форумах, поэтому я выкладываю solution. Листинг библиотеки (nthide.dll), которая будет выполнять нужную нам функцию:</p>
<pre>library hide;
uses
 Windows,
 SysUtils,
...
<p>Для её использования нужно вызвать функцию HideProcess:</p>
<p>function HideProcess(pid:DWORD; HideOnlyFromTaskManager:BOOL):BOOL,</p>
<p> где</p>
<p>pid - идентификатор процесса, который нужно спрятать</p>
<p>HideOnlyFromTaskManager - нужно ли прятать процесс только от TaskManager'а, или же от остальных программ, использующих для получения списка процессов функцию NtQuerySystemInformation из ntdll.dll.</p>
<p>Пример использования:</p>
<p>function HideProcess(pid: DWORD; HideOnlyFromTaskManager: BOOL): BOOL; stdcall; external 'nthide.dll';</p>
<p>&lt; skipped &gt;</p>
<p>procedure proc;</p>
<p>begin</p>
