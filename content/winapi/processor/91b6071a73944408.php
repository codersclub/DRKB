<h1>Как получить информацию о процессоре?</h1>
<div class="date">01.01.2007</div>


<p>О процессоре можно на любом уровне (приложении или драйвере) получить информацию с помощью команды(машинной) CPUID(386+):</p>
<p>Например(Вставка на асм в языке Паскаль):</p>
<pre>
...
<p>Передать в Паскаль содержимое регистров можно, например, так:</p>
<pre>
var
...
<hr /><p>Как узнать тип процессора (через реестр)?</p>
<pre>
...
<p>Источник: <a href="https://community.borland.com" target="_blank">https://community.borland.com</a></p>
<p>Прислал p0sol</p>
<hr />
<pre>
unit ExpandCPUInfo;
