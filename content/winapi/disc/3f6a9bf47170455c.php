<h1>Информация о физических дисках</h1>
...
<p>&gt;&gt; Поличение серийного номера IDE диска.</p>
<p>Функция получает серийный номер первого физического диска IDE (не серийный номер тома!).</p>
<p>Используется S.M.A.R.T. API, а под Windows NT/2K/XP запрос производится не напрямую к диску, а через miniport драйвер контроллера, что позволяет читать серийный номер не имея прав администратора.</p>
<p>Функция может не работать, если первый контролер в системе не ATA или если первое устройство не является винчестером, который поддерживает SMART (современные винчестеры поддерживают). </p>
...
<p class="author">Автор:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Alex Konshin, akonshin@earthlink.net, Boston, USA</p>
