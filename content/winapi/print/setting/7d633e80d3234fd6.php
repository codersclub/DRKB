...
<p>где:</p>
<table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>hPrinter &#8212; идентификатор принтера, к которому производится запрос;</td></tr></table></div><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>FirstJob &#8212; номер первого запрашиваемого задания;</td></tr></table></div><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>NoJobs &#8212; количество запрашиваемых заданий;</td></tr></table></div><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>Level &#8212; тип структуры, которая передается в pJob;</td></tr></table></div><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>PJob &#8212; указатель на массив переменных типа JOB_INFO_1 при Level=1 и JOB_INFO_2 при Level=2 (см. таблицу 1 и 2);</td></tr></table></div><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>CbBuf &#8212; размер буфера данных;</td></tr></table></div><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>PcbNeeded &#8212; переменная, в которую заносится количество записанных в буфер данных (при удачном завершении функции) или же необходимый размер буфера в байтах (при неудачном завершении);</td></tr></table></div><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>PcReturned &#8212; количество занесенных в буфер записей, в которых содержится актуальная информация.</td></tr></table></div><p><img src="/pic/clip0258.gif" width="324" height="339" border="0" alt="clip0258"><img src="/pic/clip0259.gif" width="320" height="340" border="0" alt="clip0259"></p>
...
<p>где:</p>
<table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>Flags &#8212; флаги, которые дазают особенности перечисления принтеров (см. таблицу 3);</td></tr></table></div><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>Name &#8212; название принт-объекта; значение этого параметра используется в паре с Level (таблица 4);</td></tr></table></div><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>Level &#8212; индекс уровня; используется вместе с Name (таблица 4);</td></tr></table></div><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>PPrinterEnum &#8212; указатель на массив элементов одного из типов TPrinterInfo1, TPrinterInfo2, TPrinterInfo4, TPrinterInfo5 (таблица 4);</td></tr></table></div><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>CbBuf &#8212; размер буфера pPrinterEnum;</td></tr></table></div><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>PcbNeeded &#8212; переменная. в которой содержится количество байт, скопированных при удачном завершении операции, или же размер недостающей памяти, если значение cbBuf слишком мало;</td></tr></table></div><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>PcReturned &#8212; количество актуальных записей, занесенных в буфер.</td></tr></table></div><p><img src="/pic/clip0260.gif" width="322" height="381" border="0" alt="clip0260"><img src="/pic/clip0261.gif" width="325" height="278" border="0" alt="clip0261"></p>
