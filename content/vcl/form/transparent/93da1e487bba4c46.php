<h1>Как сделать прозрачное окно родными средствами Windows2000?</h1>
<div class="date">01.01.2007</div>


<p>В Windows2000 есть для этого ф-я SetLayeredWindowAttributes, вот пример её использования:</p>
<pre>
unit Win2k;
interface
