...
<table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">3.</td><td>Заменяем её на:</td></tr></table></div><p> &nbsp;&nbsp;&nbsp; if FImageIndex &lt;&gt; -1 then</p>
<p> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; fmt := fmt or LVCFMT_IMAGE or LVCFMT_COL_HAS_IMAGES</p>
<p> &nbsp;&nbsp;&nbsp; else</p>
...
<table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">1.</td><td>Откройте модуль "ComCtrls.pas" и найдите строчку "TTabSheet.UpdateTabShowing"</td></tr></table></div><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">1.</td><td>Вы увидите следующий текст:</td></tr></table></div><p>procedure TTabSheet.UpdateTabShowing;</p>
<p>begin</p>
<p>  SetTabShowing((FPageControl &lt;&gt; nil) and FTabVisible);</p>
<p>end;</p>
<table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">3.</td><td>Добавьте следующую строчку в эту процедуру:</td></tr></table></div><p>SetWindowLong(handle,GWL_EXSTYLE,WS_EX_TRANSPARENT);</p>
<table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">4.</td><td>Если в вашем TPageControl создано более одного TTabSheet, возможно при запуске вашего приложения вы увидите все компоненты отрисованные на первом листе (TTabSheet). Не надо впадать в панику... Найдите метод "TPageControl.Loaded" и измените его чтобы он был похож на следующий код:</td></tr></table></div><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">5.</td><td></td></tr></table></div>
<pre>
...
<table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">1.</td><td>Откройте "ComCtrls.pas" и найдите "TTrackBar.CreateParams".</td></tr></table></div><table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">1.</td><td>Вы увидите следующий код:</td></tr></table></div>
<pre>
