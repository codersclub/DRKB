...
<table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>1. WindowsXP.RC</td></tr></table></div>
<table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>2. WindowsXP.Manifest</td></tr></table></div>
<p>Файл WindowsXP.RC содержит инструции для подключения WindowsXP.Manifest (XML-документа), а именно:</p>
<table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">&#183;</td><td>1 24 "WindowsXP.Manifest"</td></tr></table></div>
<p>Сам манифест - XML документ содержащий информацию о вашем приложении которую вы добавляете как и информацию содержащую версию библиотеки comctl32.dll для использования. Его содержание должно быть немного заточено под ваше приложение, но будет выглядеть примерно так:</p>
<pre>
...
<table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">1.</td><td>Открыть "ComCtrls.pas" и найти "TCustomListView.UpdateColumn"</td></tr></table></div>
<table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">1.</td><td>Найдем следующую строку.</td></tr></table></div>
<p>     if FImageIndex &lt;&gt; -1 then</p>
<p>        fmt := fmt or LVCFMT_IMAGE or LVCFMT_COL_HAS_IMAGES;</p>
<table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">3.</td><td>Заменяем её на:</td></tr></table></div>
<p>     if FImageIndex &lt;&gt; -1 then</p>
<p>       fmt := fmt or LVCFMT_IMAGE or LVCFMT_COL_HAS_IMAGES</p>
<p>     else</p>
<p>       mask := mask and not (LVCF_IMAGE);</p>
<table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">4.</td><td>Сохраняем Comctrls.pas. Теперь TListView не вызывает ошибку в режиме vsReport под Windows XP.</td></tr></table>
...
<table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">1.</td><td>Откройте модуль "ComCtrls.pas" и найдите строчку "TTabSheet.UpdateTabShowing"</td></tr></table></div>
<table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">1.</td><td>Вы увидите следующий текст:</td></tr></table></div>
<p>procedure TTabSheet.UpdateTabShowing;</p>
<p>begin</p>
<p>  SetTabShowing((FPageControl &lt;&gt; nil) and FTabVisible);</p>
<p>end;</p>
<table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">3.</td><td>Добавьте следующую строчку в эту процедуру:</td></tr></table></div>
<p>SetWindowLong(handle,GWL_EXSTYLE,WS_EX_TRANSPARENT);</p>
<table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">4.</td><td>Если в вашем TPageControl создано более одного TTabSheet, возможно при запуске вашего приложения вы увидите все компоненты отрисованные на первом листе (TTabSheet). Не надо впадать в панику... Найдите метод "TPageControl.Loaded" и измените его чтобы он был похож на следующий код:</td></tr></table></div>
<table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">5.</td><td></td></tr></table></div>
<pre>
...
<table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">1.</td><td>Откройте "ComCtrls.pas" и найдите "TTrackBar.CreateParams".</td></tr></table></div>
<table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">1.</td><td>Вы увидите следующий код:</td></tr></table></div>
<pre>
...
<table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">3.</td><td>Добавьте условие "or TBS_TOOLTIPS" в линию "Style:=". В конечном итоге должно получиться:</td></tr></table></div>
<pre>
Style := Style or OrientationStyle[FOrientation] or 
      TickStyles[FTickStyle] or ATickMarks[FTickMarks] or TBS_FIXEDLENGTH or 
      TBS_ENABLESELRANGE or TBS_TOOLTIPS; 
</pre>
<table border="0" cellpadding="0" cellspacing="0" style="line-height: normal;"><tr><td width="24">4.</td><td>Сохраните ComCtrls.pas и наслаждайтесь подсказкой.</td></tr></table></div>Автор поправки Matteo Riso.</p>
