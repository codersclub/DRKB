...
<div style="text-align: left; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 5px 0px 5px 0px;"><pre>type
...
<div style="text-align: justify; text-indent: 0px; padding: 0px 0px 0px 0px; margin: 0px 0px 8px 0px;"><pre>procedure OnConnection(
...
<pre>procedure TBaseSink.Connect(pSource: IUnknown);
var
...
<pre>procedure TBaseSink.Disconnect;
begin
  if FSource = NIL then
 &nbsp;&nbsp; Exit;
  try
...
<pre>constructor TCommandButtonEventSink.Create;
begin
  inherited;
...
<pre>function TCommandButtonEventSink.DoInvoke(DispID: Integer;
...
<pre>procedure TDirectoryList.OnConnection(const HostApp: IDispatch;
  ext_ConnectMode: Integer; const AddInInst: IDispatch;
  var custom: PSafeArray);
begin
