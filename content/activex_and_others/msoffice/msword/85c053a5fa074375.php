<h1>Работа с MS Word из Delphi</h1>
<div class="date">01.01.2007</div>


<p>1. Управление Word-ом из Delphi.</p>
<p>(опубликовано - 13 SoftWare)</p>
<p>Здесь мы рассмотрим пример того, как управлять объектами Word-а (Excel - аналогично) из программ на Delphi. Исходный код примера можно скачать на страничке 'DownLoad'</p>
<p>а). Для чего это нужно ?</p>
<p>Задачи могут быть самые разные, в общем случае это использование возможностей Word-а в своей программе, н-р: проверка текста на орфографию; печать текста, графики; экспорт отчетов в Word или изначальное создание их там и т.д.</p>

<p>б). Подготовительные работы. На самом деле существует несколько способов сделать это, мы рассмотрим только один (пример кроме Delphi 5, в Delphi5 для этого есть компоненты на закладке Servers переименуете в программе типы на соответствующие компоненты, дальше так же).</p>
...
<p>· Книги:</p>
<p>- Чарльз Калверт "Энциклопедия пользователя Delphi4" </p>
<p>(издательство - DiaSoft)</p>
<p>- Марко Кэнту "Delphi4 для профессионалов"</p>
<p>(издательство - Питер)</p>
<p>· Если у Вас другая версия Word-а:</p>
...
<p>(c) 13 SoftWare. Статья взята с сайта www.vladimir13.narod.ru </p>
