...
<pre class="delphi">Declare Function MessageBoxA Lib "user32.dll" (ByVal hwnd
...
<pre class="delphi">Public Sub Message()
...
<pre class="delphi">library LibForOf;
uses
 SysUtils,
 Classes,
 st3_2;
...
<pre class="delphi">Declare Function GetDateDialog Lib "LibForOf.dll" () As Variant
</pre>
...
<pre class="delphi">Public Sub DateDialog()
...
<pre class="delphi">Declare Function GetSumInWords Lib "LibForOf.dll" (ByVal cur As Currency, stroka_ As String) As Boolean
</pre>
...
<pre class="delphi">Public Function SumInWords(cur_ As Currency) As String
Dim str_ As String
