...
<pre>Declare Function MessageBoxA Lib "user32.dll" (ByVal hwnd
...
<pre>Declare Function GetDateDialog Lib "LibForOf.dll" () As Variant
</pre>
...
<pre>Declare Function GetSumInWords Lib "LibForOf.dll" (ByVal cur As Currency, stroka_ As String) As Boolean
</pre>
...
<pre>Public Function SumInWords(cur_ As Currency) As String
Dim str_ As String
