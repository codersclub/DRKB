...
<p>Когда объект выделен, можем изменить его шрифт, для этого используем приведенную ниже функцию для объекта Selection:</p>
...
<pre class="delphi">SelectCell(tab_,2,3); SetFontSelection(Button2.font,5);</pre>
