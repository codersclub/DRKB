...
<pre class="delphi">uses ComObj, Classes;
var E:variant;
...
<pre class="delphi">Function OpenWorkBook(file_: string):boolean;
begin
 OpenWorkBook:=true;
 try
...
<pre class="delphi">Function AddSheet(newsheet:string):boolean;
begin
 AddSheet:=true;
 try
  E.Sheets.Add;
...
<pre class="delphi">Function DeleteSheet(sheet:variant):boolean;
begin
 DeleteSheet:=true;
 try
...
<pre class="delphi">For a_ = 1 To Sheets.Count
...
<pre class="delphi">Function CountSheets:integer; // получаем количество листов книги
begin
  try
...
<pre class="delphi">Function SaveWorkBookAs(file_:string): boolean;
begin
  SaveWorkBookAs:=true;
  try
    E.DisplayAlerts:=False;
...
<pre class="delphi">For a_ = 1 To Application.Workbooks.Count
...
<pre class="delphi">Function CloseWorkBook:boolean;
begin
 CloseWorkBook:=true;
 try
...
<pre class="delphi">Function CloseExcel:boolean;
begin
 CloseExcel:=true;
 try
  E.Quit;
