...
<pre>Function SeriesCount (Name:variant):integer;
begin
 SeriesCount:=-1;
 try
...
<pre>Function BarShapeSeries (Name:variant;series,BarShape:integer):boolean;
begin
 BarShapeSeries:=true;
 try
...
<pre>E.Charts.Item[name].SeriesCollection.Item[series].Border.Color:=Color;
