---
Title: Cоздание документа MS Word
Date: 01.01.2007
---
...
поручения.doc\". Полный пример с исходными текстами можно взять на моей
домашней странице (www.kornjakov.ru/st1\_2.zip), а здесь, с целью
экономии объема, представлен только фрагмент документа (см.рис.).

![clip0068](/pic/clip0068.gif){width="449" height="120"}
