<h1>Как можно работать с DDE?</h1>
<div class="date">01.01.2007</div>


<p>Как можно работать с DDE под Delphi, используя вызовы API&nbsp;</p>

<p>Кстати, достаточно легко: следующий пример демонстрирует как можно научить общаться клиентскую программу с программой-сервером. Обе программы полностью созданы на Delphi. В итоге мы имеет 2 проекта, 3 формы и 3 модуля. Для работы с DDE-запросами данный пример использует методы DDE ML API.</p>

<p>Сервер должен начать свою работу перед тем, как клиент будет загружен. Данный пример демонстрирует 3 способа взаимодействия между клиентом и сервером:</p>
...
<p>Как работает программа.</p>
<p>Ниже приведены 8 файлов, сконкатенированных в единое целое. Каждый файл имеет следующую структуру:</p>
<p>{ *** НАЧАЛО КОДА FILENAME.EXT *** } КОД { *** КОНЕЦ КОДА FILENAME.EXT *** },</p>
<p>поэтому вам остается всего-лишь взять код, расположенный между маркерами { *** }, скопировать в файл с соответствующим именем, и собрать оба проекта в среде Delphi</p>
