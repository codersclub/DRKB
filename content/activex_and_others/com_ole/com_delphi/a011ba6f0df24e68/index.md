...
Int        SYSINT        Машинно-зависимый целый тип данных, в настоящее
время объявлен как Integer, однако, в будущем может иметь другую
разрядность      
...
BSTR        WideString        В Automation нельзя использовать строки
Delphi      
...
SAFEARRAY        PSafeArray        Массив из элементов любого
поддерживаемого типа      

Decimal        TDecimal        96 битное десятичное число.      

Interface IDispatch \*        IDispatch        Ссылка на IDispatch или
любой унаследованный от него интерфейс      

Interface IUnknown \*        IUnknown        Ссылка на произвольный
интерфейс      
...
![clip0236](/pic/clip0236.gif){width="216" height="200"}
...
\<BODY LANGUAGE = VBScript ONLOAD = \"Page\_Initialize\"\>

\<CENTER\>

   \<OBJECT CLASSID=\"clsid:344E2D50-7B91-11D4-84DD-97E4E55E3E05\"
ID=Ctrl1\>
...
\<SCRIPT LANGUAGE = VBScript\>
  ...
  Sub Page\_Initialize

   Ctrl1.FireEvent

  End Sub

  Sub Ctrl1\_TestEvent
...
![clip0237](/pic/clip0237.gif){width="464" height="281"}
...
![clip0238](/pic/clip0238.gif){width="613" height="400"}
...
![clip0239](/pic/clip0239.gif){width="356" height="275"}
...
![clip0240](/pic/clip0240.gif){width="477" height="581"}
...
![clip0241](/pic/clip0241.gif){width="636" height="244"}
