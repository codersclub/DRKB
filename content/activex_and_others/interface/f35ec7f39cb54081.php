<h1>Ревизия интерфейсов (статья)</h1>
<div class="date">01.01.2007</div>

<div class="author">Автор: Cary Jensen</div>
<div class="author">Перевод: Мотов Олег, olegm@tebuk.parma.ru, http://olegmotov.h1.ru</div>

<h2>Часть 1: Объявления, реализация и разрешение имен методов</h2>
...
<img src="/pic/embim1908.png" width="29" height="29" vspace="1" hspace="1" border="0" alt="">
<img src="/pic/embim1909.png" width="29" height="29" vspace="1" hspace="1" border="0" alt="">
<img src="/pic/embim1910.png" width="29" height="29" vspace="1" hspace="1" border="0" alt=""></p>
<img src="/pic/embim1911.png" width="29" height="29" vspace="1" hspace="1" border="0" alt="">
<img src="/pic/embim1912.png" width="29" height="29" vspace="1" hspace="1" border="0" alt=""></p>

<hr />

<h2>Часть 2: Интерфейсные ссылки против объектных ссылок</h2>
...
- Интерфейсной ссылке присваивается значение nil.<br>
- Интерфейсной ссылке переназначается другой объект, реализующий интерфейс.<br>
- Интерфейсная ссылка выходит из области видимости.<br>
Как Вы можете видеть на рисунке 1, когда вызывается метод _Release и счетчик ссылок уменьшается до нуля, автоматически вызывается деструктор объекта.</p>
