...
I -- й этап. В этом тесте, все участники выполняют следующее задание:
...
II -- й этап. В этом тесте, все участники выполняют следующее задание:
...
III -- й этап. В этом тесте, все участники выполняют следующее задание:
...
входящей в поставку любой версии среды программирования от фирмы Borland
- biolife.db.
...
IV -- й этап. В этом тесте, все участники выполняют следующее задание:
...
Copyright© 2006 Сергей Медведев Специально для [Delphi
Plus](https://www.delphiplus.org/)
