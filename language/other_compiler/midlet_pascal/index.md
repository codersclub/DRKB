...
Author: XProger <https://www.mirgames.ru>
Date: 01.01.2007
---
...
должна выглядеть приблизительно так
    ...
    C:\MP\Midp2Exe.exe -jar %JAR% -r

Сохраняем изменения и возвращаемся к главному окну программы.
...
Собственно, запустите эту программу на своём телефоне, и Вашему счастью не
будет предела.
