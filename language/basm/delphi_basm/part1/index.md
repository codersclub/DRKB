...
Так же, вы должны с осторожностью объявлять и использовать локальные
...
результат. Так, где же хранится действительное содержимое результата
...
S:=PlusMinusLine(9), то S должна получить значение: "-+-+-+-+-".
...
мы рассмотрим в главе 1.9. EDX не содержит самого указателя, но
