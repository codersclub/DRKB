...
1. **Загрузка модулей через LoadLibrary** - вызовы из WinAPI были заменены
...
2. **Критические секции и объекты синхронизации**
...
3. **Запуск процессов** - все функции были выделены в отдельный модуль с
...
4. **Движок двумерной графики Direct2D**. В старых версиях программы под Windows в качестве рендера использовался
