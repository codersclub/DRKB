...
описанных в Windows.pas. Нас интересует WH\_KEYBOARD       lpFn      
 Адрес функции, которая будет автоматически вызываться каждый раз при
возникновении события.       hMod        Идентификатор модуля, в котором
...
Внимание! Если Вы используете такой модуль в разных проектах, то каждый
