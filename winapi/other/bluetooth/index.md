...
- manufacturer    - Код производителя (константы BTH\_MFG\_Xxx). Для получения новых кодов обратитесь к сайту спецификаций Bluetooth
...
об устройстве. dwSize должен быть равен размеру структуры. addreess
должен содержать адрес устройства, о котором хотим
получить информацию.
...
- dwSize               - Входной параметр. Должен быть равен размеру структуры (dwSize := SizeOf(BLUETOOTH\_DEVICE\_SEARCH\_PARAMS))
...
- dwSize          - Входной параметр. Должен быть равен размеру структуры (dwSize := SizeOf(BLUETOOTH\_DEVICE\_INFO))
...
- dwSize          - Должен быть равен размеру структуры (dwSize := SizeOf(BLUETOOTH\_RADIO\_INFO))
