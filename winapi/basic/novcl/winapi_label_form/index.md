...
Source: Vingrad.ru <https://forum.vingrad.ru>
    ...
    var 
      hLabel : HWND ;
    ...
    hLabel := CreateWindow ( 'STATIC', 'test', WS_CHILD or WS_VISIBLE,
                             0, 0, 200, 40, hWnd, NULL, hInstance, NULL ); 

**Примечание: Vit**

Скорее всего последний параметр не "NULL", а "Nil"
(NULL в паскале - варианта для обозначения пустого поля в базе данных)
...
Source: Vingrad.ru <https://forum.vingrad.ru>
    ...
    begin
      ...
      case AMessage of
        {WM_COMMAND: if lParam = Button1 then
          MessageBox( 0, 'Вы нажали кнопку!', 'Информация', MB_OK or MB_ICONINFORMATION); }
        WM_DESTROY: Halt;
      end;
    end;
    ...
    begin
      ...
      Label1:= CreateWindow( 'Label', 'Text', WS_VISIBLE or WS_CHILD or WM_SETTEXT,
