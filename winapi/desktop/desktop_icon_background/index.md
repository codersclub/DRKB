...
который содержит иконки рабочего стола).

Сперва будем искать главное
...
можно будет воспользоваться макросами `ListView_SetTextBkColor` и
`ListView_SetTextColor` для установки желаемого цвета.
