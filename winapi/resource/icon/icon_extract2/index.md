...
воспользоваться компонентами с закладки Win3.1.

- Вынесите на форму компонент TFileListBox;
- затем TDirectoryListBox,
- в свойстве FileList укажите на список файлов [TFileListBox];
- после этого возьмите компонент класса TDriveComboBox, указав в его свойстве DirList на список
каталогов [TDirectoryListBox],
- ну, и, наконец, ставьте TFilterComboBox, который позволит в списке файлов отображать только те
файлы, которые соответствуют маске, указанной в свойстве Filter.

    Здесь в качестве значения укажите следующее:
    ico\|\*.ico\|dll\|\*.dll\|exe\|\*.exe\|all\|\*.ico; \*.dll; \*.exe
