---
Title: Создание консольных приложений
Date: 01.01.2007
---
...
Как уже отмечалось в совете [/language/oop/component_dev/custom_class/](/language/oop/component_dev/custom_class/)
(да и в Хелпе) в консольных
...
3. В проекте содержится один модуль формы. Выберите его и щелкните на
...
**Совет:**
Поставляемая с Delphi система справки по Win32 содержит функции
