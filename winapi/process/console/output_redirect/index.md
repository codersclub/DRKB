...
ожидал, что в век GDI мне придется возиться с консолью... Ан нет,
пришлось.
...
Ага, а как? Вот тут-то всё и началось...
...
Поискал на КД. Нашел вот такую штуку: _Как переназначить StdOut в файл
для консольной программы запускаемой по CreateProcess_
...
_\- Ну, создали мы процесс и что дальше?_
