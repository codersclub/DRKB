...
- SEMAPHORE\_MODIFY\_STATE        Поток может увеличивать счетчик семафора функцией ReleaseSemaphore
...
- TIMER\_MODIFY\_STATE        Разрешает изменять состояние таймера функциями SetWaitableTimer и CancelWaitableTimer
