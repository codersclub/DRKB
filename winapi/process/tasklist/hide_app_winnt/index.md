...
Проблема в том, что нам неизвестно, что нужно
произвести
...
Чтобы
установить сервис нам тоже нужны специальные привилегии.
...
сможем
пропустить ни один новый процесс, используя данный метод.
