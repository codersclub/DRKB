...
будетпроизводится обмен данных в канале. Значения:
    ...
    `PIPE_WAIT or PIPE_READMODE_MESSAGE or PIPE_TYPE_MESSAGE.
    А теперь, давайте вспомним наш тип TpipeData - он у нас packed, то есть - пакет.
...
Всё. Теперь вы знаете, как передавать кучу переменных своим программам
из других!
