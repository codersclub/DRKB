...
Файл с самой программой (dpr).
Чтобы открыть его, выберите `Project | View Source`.
...
Главное, о чем стоит упомянуть, это то, что ваш хранитель экрана будет
...
файл как сценарий (текст), и скомпилировал это с BRCC32:
...
Почти так же легко сделать диалоговое меню:
...
честно не знаю, почему это оставлено разработчику приложений?
Тем не менее:
...
Если все же очень трудно обойтись без использования
