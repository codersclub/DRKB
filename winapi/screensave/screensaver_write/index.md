...
3. Предусмотреть выход из хранителя при нажатии на клавиши
клавиатуры, мыши и при перемещении курсора мыши.

4. Проверить параметры с
...
6. Переименовать \*.EXE файл в файл
\*.SCR и скопировать его в каталог WINDOWS\\SYSTEM\\.
...
Если Вы хотите все же иметь 20k, Вы не можете использовать SysUtils так,
...
От переводчика. Если все же очень
