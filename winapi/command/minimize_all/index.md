...
- импортировать Microsoft Shell Controls & Automation Type Library.

- В меню `Project..Import Type Library` выберите `Microsoft Shell Controls & Automation (version 1.0)`.
...
- Перетащите на форму компонент TShell.
