...
кодом) на
[https://www.torry.net/mixer.htm](https://www.torry.net/mixer.htm).
Компонент называется **Vumeter v.1.0**.
Я его не разбирал, но похоже что он
...
универсальная. Но работает нормально.

По времени: обработка файла и
