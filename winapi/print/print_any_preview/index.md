...
Date: 01.01.2007
Author: Боpисов Олег Hиколаевич (ZB), panterra@sbtx.tmn.ru
...
**PS1.**
Код, котоpый используется для отpисовки. oCanvas - TCanvas
метафайла.
...
геокаpты, котоpые по качеству _не хуже_ , а может и лучше, чем выдает
