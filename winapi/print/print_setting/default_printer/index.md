...
изменнеия текущего принтера на другой.

Хочу добавить, что реализация
через API может несколько различаться для разных версий Windows и
простой код по изменению текущего принтера вовсе не факт, что будет работать
