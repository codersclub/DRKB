...
Author: Матвеев Игорь, teap_leap@mail.ru
Date: 01.01.2007
...
**ПРИМЕЧАНИЕ:**
Так как алгоритм шифрует данные блоками по 8 байт, а размер
шифруемых данных не всегда кратен 8, поэтому в данном модуле последний
блок, если он размером больше ноля и меньше восьми, не шифруется.
