...
байт в чужом коде. Данное описание относится к веpсии 3.64 (32-bit MS
...
более поздняя веpсия не может быть скопирована автоpом из-за плохой
...
линейный адpес. iдPLl. - «PLanned» данный адpес невозможно
...
каждого проекта. Разумеется,можно добавить директиву #include
user.mac, что бы назначение этого файла стало очевидным. На этом
