...
1) This is the FREEWARE Version of the HTML Compiler. This FREEWARE version
...
2) Versions available. This version - Stand-Alone HTML Compiler PRO
Compiles HTML text and images (including frames) into a single
stand-alone executable.

3) Stand-Alone HTML Compiler PRO + enables the creation of shareware ebooks
...
1. Засунуть в Ida Pro. Найти инструкцию popad. Посмотреть куда направляется
...
2. Воспользоваться самим Upx

2. Проделать только в отладчике.
...
Part1.exe через Windows Commander 32.  
It works...
