...
после замещения тэга \<#CUSTLIST\> реальными данными (в данном примере
--- списком клиентов из демонстрационной базы данных customer.db) будет
...
Подкатегория Indy Misc включает в себя такие компоненты, как кодеки
