...
Date: 01.01.2007
Source: http://homepages.borland.com/aohlsson/Articles/CounterCGI.html
---
...
_(Перевод одноимённой статьи с сайта
http://homepages.borland.com/aohlsson/Articles/CounterCGI.html)_
...
CGI скрипт также может получать определённый набор параметров:
...
Начать создавать новое CGI приложение следует с выбора
...
Наслаждайтесь счётчиком, сделанным в Delphi 5 :)
