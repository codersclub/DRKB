...
Команда LOGIN.
: После того как по транспортному протоколу (например,
...
Команда SELECT
: устанавливает текущий каталог для работы клиента.

Команда EXAMINE
: Если пользователю необходимо получить информацию о состоянии какого-либо
...
Команда COPY
: копирует сообщения с заданными порядковыми номерами в указанный каталог, например:
