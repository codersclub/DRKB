...
[rfc 1459](https://datatracker.ietf.org/doc/html/rfc1459) для (Internet Relay Chat Protocol).
...
Все поля будут заполняться из введеных пользователем строк в Edit\'ы.
...
Тут же ( `cs.Socket.SendText('JOIN' + ' #' + Info.sChan + #13#10);` )
