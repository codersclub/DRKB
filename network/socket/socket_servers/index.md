...
Date: 12.02.2001
Author: Карих Николай (Nitro) (snick@mailru.com)
...
![Image0055.gif](Image0055.gif)
![Image0056.gif](Image0056.gif)
![Image0057.gif](Image0057.gif)
![Image0056.gif](Image0056.gif)
![Image0058.gif](Image0058.gif)
![Image0059.gif](Image0059.gif)
![Image0060.gif](Image0060.gif)
![Image0056.gif](Image0056.gif)
![Image0061.gif](Image0061.gif)

Разберем схему подробнее:

- Определение свойств Port и ServerType - чтобы к серверу могли нормально подключаться клиенты, нужно, чтобы порт, используемый сервером точно совпадал с портом, используемым клиентом (и наоборот). Свойство ServerType определяет тип подключения (подробнее см.ниже);
...
сообщений через сокеты.
    ...
    {Полный исходник смотри здесь:
     http://delphi.mastak.ru/articles/socksrv/srv_exe.zip}
