...
жаль... вот что получается: константа FLAG\_ICC\_FORCE\_CONNECTION
...
Для задания стандартных портов служат константы:
    - INTERNET\_DEFAULT\_FTP\_PORT (port 21)
    - INTERNET\_DEFAULT\_GOPHER\_PORT (port 70)
    - INTERNET\_DEFAULT\_HTTP\_PORT (port 80)
...
HttpOpenRequest и HttpSendRequest используются вместе
