...
5.   В следующем окне выбираем вкладку "Into new package".
6.   Выбираем путь куда будет установлен наш ActiveX package и имя для него.

    ![](clip0316.gif)

5.   Далее жмем "Ok".
6.   После долгого раздумья появится окно, в котором нажмите "Compile".

    ![](clip0317.gif)

7.   После чего в выскочившем сообщении нажмите "Ok".
8.   Закройте все с сохранением вашей новой библиотеки.
...
требующая, ни от куда не списанная (даже упоминаний о DHTMLEdit\'оре
нигде не слышал). Описанный контрол, технической поддержке со стороны
