---
Title: 11. Прокси (proxy - заместитель, уполномоченный)
Date: 12.12.2006
...
другой сети или внешней сети, к которой подключена внутренняя сеть.
_(Бр - фраза, не подлежащая к переводу, очень трудная к пониманию,
...
работает, поскольку удаленное место неизвестно до общения
_(речь про доступ изнутри)._
