...
Date: 01.01.2007
Author: Александр Гарустович
Source: <https://www.mirgames.ru/>
---
...
v1 текстурные координаты будут (1, 0), для v0 будут (1, 1),
для v3 (0, 0), для v2 (0, 1), потом опять (1, 0) и (1, 1) и так далее.

**Одно замечание:** для этого метода нужно отключить mipmapping, иначе могут
