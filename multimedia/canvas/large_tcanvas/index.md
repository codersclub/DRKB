...
[TCanvas.zip](http://delphi.mtu-net.ru/zip/tcanvas.zip),
в котором возникают изложенные выше проблемы.
...
возникала на любой машине, на которой стоит Windows 9x. Поэтому я хотел
