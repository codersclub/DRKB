...
![shuffler.gif](shuffler.gif){.center}
...
получилась лучше, я изменил [свойства дисплея](https://sources.ru/delphi/delphi_get_and_set_display_modes.shtml).
...
Здесь можно посмотреть [код проекта](https://sources.ru/delphi/delphi_screen_shuffling_src.shtml).
...
можно посмотреть в статье ["Пишем Screensaver в Delphi"](https://sources.ru/delphi/delphi_write_screensaver.shtml).
