...
2. Реализуй, чтобы вторым игроком управлял не человек,
а созданный тобой интеллект.
...
Во-первых, если объект с чем-то взаимодействует,
то не забываете в DoMove вставлять:
