...
Author: Сергей Котов (kotov@rosagrosnab.ru)
Date: 19.10.2001
---
...
_"XG лучше звучит чем GM"._ Да, спецификация XG предоставляет больше
...
_"GM и его последующие дополнения единственно возможные способы
управления электронными инструментами"._ MIDI, вообще-то, проектировался
