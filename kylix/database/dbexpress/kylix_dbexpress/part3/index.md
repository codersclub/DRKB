...
Способ №1: анализировать содержимое файлов dbxconnections и dbxdrivers.
...
Способ №3 Использование интерфейса IConnectionAdmin (определен в модуле
...
Function Execute (const SQL: string; Params:TParams; ResultSet: Pointer
= nil):integer;
...
ВНИМАНИЕ: я пробовал устанавливать в TableScope все элементы, но при
