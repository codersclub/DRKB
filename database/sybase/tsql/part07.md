...
рассматриваются в этой главе, в то время как индексы обсуждаются в главе 11.
...
> **Замечание.**  
> В предыдущих примерах и в примерах из следующего раздела
...
количество сегментов, которые могут выделяться одной базе данных,
равно 32.
...
> **Замечание.**  
> Не следует создавать противоречий между ограничениями,
...
Точно так же процедуру sp\_rename можно использовать для переименования
...
в качестве аргумента:
    ...
    ---------  -----------  ----------  -----------------------  --------------------
    publisher  dbo          user table  default                  Jan  1 1900 12:00AM
