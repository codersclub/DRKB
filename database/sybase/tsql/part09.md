...
**Замечание.**  
Можно выбирать текстовую и графическую информацию из
...
### 1) Вычисляемые столбцы в определении вьювера
...
### 2) Предложения group by и compute by в определении вьювера
...
### 3) Неопределенные значения в базовых объектах
...
### 4) Вьюверы, определенные с опцией with check option
...
вьювера. Например:
    ...
    (Объекты текущей базы данных, которые зависят от данного объета).
