...
> **Замечание:**  
> Вызов удаленной процедуры не является
...
> **Замечание:**  
> Если параметры задаются в виде "@параметр=значение", то их
...
> **Замечание:**  
> Если параметры задаются в виде "@параметр=значение", то они
...
> **Внимание:**  
> Вызовы удаленных процедур не являются частью транзакции.
...
> **Замечание:**  
> Если сохраненная процедура требует нескольких параметров, то
