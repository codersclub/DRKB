...
> **Замечание:**  
> В идентификаторах можно использовать множество многобайтных
...
(эт), &yen; (йена) или &pound; (фунт стерлингов).
...
Transact-SQL ключевых слов.
    ...
    --------------------------------+--------------------------------
     user_name (встроенная функция) | user (ключевое слово)          
    --------------------------------+--------------------------------
