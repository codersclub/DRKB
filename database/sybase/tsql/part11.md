...
> **Замечание:**  
> Опция название\_сегмента в команде создания индекса позволяет
...
> **Замечание:**  
> Поскольку нижний (листовой) уровень кластеризованного индекса
...
> **Замечание:**  
> Если выполняется оператор обновления и в столбец записывается
...
> **Замечание:**  
> Оператор обновления отменяется, если при его выполнении
...
из базы данных. Эта команда имеет следующий синтаксис:
    ...
    drop index название_таблицы.название_индекса
             [,название_таблицы.название_индекса]...
...
следующий синтаксис:
    ...
    update statistics название_таблицы [название_индекса]
