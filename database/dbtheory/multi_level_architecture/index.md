...
Попытаемся разбить систему на функциональные фрагменты.
...
2. "Тонкий" клиент. Модель [^3], начинающая активно использоваться в корпоративной среде в связи с распространением Internet-технологий и, в первую очередь, Web-браузеров. В этом случае клиентское приложение обеспечивает реализацию PL, а сервер объединяет BL и AL.
...
_многопользовательского_ доступа к информационным ресурсам, в этой
...
Сергей Орлик, московский офис Borland тел.: 238-3611
