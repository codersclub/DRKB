...
или инструмент для удовлетворения специфической потребности,  
для которой другой инструмент более действенен  
...
6. Что и как из классических методов проектирования применяется в
...
13. От новых требований к типам и источникам информации - к новым
...
14.1. Об исключении избыточности в данных
...
14.2. Проблема консервации проблем
...
14.3. Компонентная открытость и смысловая интероперабельность
...
14.4. Разработка понятийных моделей и СКК
...
14.5. Понятийные модели и последующие проектные работы
...
14.6. Технологическая открытость
...
14.7. Проблемы объемов, временных характеристик и физического
проектирования
...
14.8. Проблема границ применимости двух основных методов проектирования
