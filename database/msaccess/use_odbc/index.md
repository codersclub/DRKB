...
Первое: проверьте, установлен ли ODBC Administrator (файл
...
было, то после установки Delphi он должен появиться.
...
обновить ее до версии, включенной в поставку Delphi.
...
файлов Access 2.5 на форуме MSACCESS CompuServe.
...
Вы можете установить новые ODBC драйверы с помощью ODBC
...
Source: Советы по Delphi, Сборник Kuliba

Source: Валентин Озеров, mailto:webmaster@webinspector.com
