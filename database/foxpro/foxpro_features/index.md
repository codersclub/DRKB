...
Максимум таблиц открывается в одно время <br>(ограничено памятью и доступными дескрипторами файла.) | 255
...
- Это основной язык написания программ Главного Научно-Вычислительного
Центра (ГНИВЦ) Министерства РФ по налогам и сборам

К достоинствам VFoxPro можно также отнести:
- возможность создания составного индекса, работа с курсорами
 (виртуальными таблицами, не отличающимися от обычных,
  но исчезающих после завершения сеанса работа,
  т.е. не остаются ни в памяти ни на диске),
- возможность экспортировать/импортировать данные в/из XML,
- возможность работы с другими базами по средствам драйвера ODBC,
...
Основными недостатками VFoxPro являются:
- большие требования к памяти, созданными на VFoxPro программами
- слабые возможности по работе с визуальными компонентами.

**Рекомендации для выбора**

Могу порекомендовать выбрать VFoxPro, тем кому
...
запросы, практически любой сложности.
...
Numeric | Целое или с дробной частью число. | 8 байтов в памяти; | от 1 до 20 байтов;<br>в таблице от -.9999999999E+19 до .9999999999E+20
...
Float | Такое же, как Numeric. | 8 байтов в памяти; | от 1 до 20 байтов;<br> в таблице от -.9999999999E+19 до .9999999999E+20
...
- Видеорежим - SVGA.
- Кроме того, необходимо, чтобы на компьютере были установленны Internet
