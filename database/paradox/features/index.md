...
Парадокс - одна из самых старых локальных баз
...
относиться с известной долей скептицизма, как и любая другая локальная
...
Alter Table, Alter Index, Join и т.д.

    Нет поддержки всторенных запросов
...
- системы репортинга, в том числе для Web - имеется встроенный не очень
мощный репортинг.
...
использующих таблицы формата парадокс.
    ...
    **Итог:**  
    с Парадокса легко перейти на почти любые другие базы данных,
...
- DBExpress - нет
- Другие: большое количество сторонних производителей компонентов,
...
отдельно уже производителями не продаётся, вместе с Corel
...
парадокс показывает практически такую-же или даже превосходящую
...
Yt htrjvtyletncz для многопользовательских проектов, там где требуется высокий уровень
защиты данных и большие массивы информации.

**13) Известные глюки и проблемы**

система очень старая, что характеризует
не только значительно устаревший интерфейс и отсутствие новомодных
наворотов, но и очень низкое количество глюков.
