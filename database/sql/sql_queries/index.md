...
запроса отображаются в табличной сетке.

В Листинге 1 полностью приведен
...
**Примечание:**
Следующий пример использует TTable с именем Table1. Для
...
**Листинг 3 - Использование события OnDataChange для просмотра дочерних записей**
