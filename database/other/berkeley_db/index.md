...
Source: Открытые системы (www.osp.ru)
---
...
>**Michael A. Olson, Keith Bostic, Margo Zeltzer. Berkley DB.**
>
...
>
>Перевод статьи публикуется с разрешения Майкла Олсона.  
>Первоначальный вариант статьи был опубликован в материалах конференции 1999 Summer Usenix Technical Conference.  
>Перевод соответствует переработанному варианту статьи, датированному июнем 2000 года.
...
в текстовых редакторах можно производить быстрый поиск по номеру строки [^10].
...
**Майкл Олсон, Кейт Бостик, Марго Зельтцер** — сотрудники компании Sleepycat Software.

----

## Берклиевская СУБД из Гарварда

Встроенную СУБД Berkeley Database (Berkeley DB),
относящуюся к категории свободно распространяемого программного обеспечения,
разрабатывает и поддерживает Sleepycat Software.
Компания была основана в 1996 году ее нынешним президентом Марго Зельцер и Кейтом Бостиком.
В настоящее время оба они являются сотрудниками Гарвардского университета,
однако в качестве первоосновы их продукта был избран Berkeley Database package,
созданный в Университете Беркли, где они работали прежде.
Таким образом, то, что называется **Berkeley DB**,
является плодом сотрудничества двух знаменитых образовательных учреждений.

Не случайно, что, добившись определенных успехов, Sleepycat Software вернула Berkeley DB «на место»,
открыв в 1998 году свое представительство в Сан-Франциско.
Штаб-квартиру в районе Залива возглавляет Майкл Олсон,
автор одной и соавтор второй из публикуемых здесь статей.

Sleepycat Software сотрудничает с более известной компанией MySQL,
СУБД которой, начиная версии MySQL 3.23.21, комплектуется средствами для обработки транзакций,
заимствованными из Berkeley DB.

Удивительно активная Марго Зельцер участвует в еще одном интересном проекте VINO,
идея которого состоит в создании альтернативных операционных систем,
называемых расширяемыми (Extensible Operating System).
Сегодня работы в этом направлении лишь начинаются, они ведутся главным образом в университетах,
их список и краткую характеристику каждой из разрабатываемых там операционных систем
можно найти в Web по адресу www.cs.arizona.edu/people/bridges/os/extensible.html.

Разработчики проекта VINO и аналогичных ему исходят из того,
что современные универсальные операционные системы
обеспечивают очень «низкий коэффициент полезного действия» серверов,
из-за них непропорционально много вычислительной мощности уходит «в тепло»,
на поддержание работоспособности самой ОС, а не пользу приложений.
Роль «вычислительного КПД» становится критически важной
при наблюдаемом экспоненциальном росте нагрузки на Internet.
VINO и его аналоги обеспечивают более полное использование ресурсов системы
за счет более эффективного управления ими.

На вопрос, почему компания названа «Спящая кошка», ответ найти очень просто.
Загляните на сайт www.seltzer.com/margo.html.

**Леонид Черняк**

### Литература

[^1]: Comer, D., «The Ubiquitous B-tree,» ACM Computing Surveys Volume 11, number 2, June 1979  
[^2]: Gray, J., and Reuter, A., Transaction Processing: Concept and Techniques, Morgan-Kaufman Publishers, 1993  
[^3]: Institute for Electrical and Electronics Engineers, IEEE/ANSI Std 1003.1, 1996 Edition  
[^4]: Litwin, W., «Linear Hashing: A New Tool for File and Table Addressing,» Proceeding of the 6th International Conference on Very Large Databases (VLDB), Montreal, Quebec, Canada, October 1980  
[^5]: The Open Group, Distributed TP: The XA+ Specification, Version 2, The Open Group, 1994  
[^6]: Opensource.org, «Open Source Definition,» www.opensourse.org/osd.html, version 1.4, 1999  
[^7]: Raymond, E.S., «The Cathedral and the Bazaar,» www.tuxedo.org/~esr/writings/cathedral-bazzar/cathedral-bazaar.htnl, January 1998  
[^8]: Seltzer, M., and Yigit, O., «A New Hashing Package for UNIX,» Proceedings 1991 Winter USENIX Conference, Dallas, TX, January 1991  
[^9]: Seltzer, M., and Olson, M., «LIBTP: Portable Modular Transactions for UNIX,» Proceeding 1992 Winter Usenix Conference San Francisco, CA, January 1992  
[^10]: Stonebraker, M., Stettner, H., Kalash, J., Guttman, A., and Lynn, N., «Document Processing in a Relational Database System,» Memorandum No. UCB/ERL M82/32, University of California at Berkeley, CA, May 1982
