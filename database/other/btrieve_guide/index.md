...
краткое описание выполняемой операцией функции.
 ...
 \-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\-\--
     ...
     (Get Next)                           текущей записью в индексном
пути

     Получить Предыдущую          7       Получает запись предшествующую

     (Get Previous)                       текущей записи в индексном
пути
     ...
     Статистика                  15       Возвращает характеристики
файла
     ...
     Начать Транзакцию           19       Отмечает начало набора
логически

     (Begin Transaction)                  связанных операций

     Закончить Транзакцию        20       Отмечает конец набора
логически
     ...
     Получить Позицию            22       Получает позицию текущей
записи
...
Записей
     ...
     Сброс                       28       Освобождает все ресурсы,
взятые

     (Reset)                              рабочей станцией

     Установить Владельца        29       Присваивает файлу имя
владельца
...
* Она связывает работу всех станций, инициирующих Btrieve- запросы к
VAP.
...
BUTIL\"
        ...
        1) Стартуйте программу BREQUEST до запуска BUTIL. Если Вам нужна
           ...
           помощь в этой процедуре, см. \"Программа BREQUEST\" в Главе
3.
        ...
        Замените \<Устройство\> именем накопителя или другого
устройства,
...
Вы
        ...
        используете звездочку вместо имени владельца, BUTIL подскажет
Вам
...
хотите
        ...
        следующем формате:
          ...
          - Последняя запись в файле должна содержать символ конца
файла.

            (Ctrl-Z или шестнадцатеричное 1A). большинство текстовых

            редакторов и команда SAVE автоматически вставляют этот
символ
